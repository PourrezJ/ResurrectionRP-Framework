...
rootProto=i,i.util.global.protobuf=i,"function"==typeof define&&define.amd&&define(["long"],function(e){return e&&e.isLong&&(i.util.Long=e,i.configure()),i}),"object"==typeof module&&module&&module.exports&&(module.exports=i)})(/* end of prelude */{1:[function(e,t){/**
...
p,l;d<e.length&&(l=e.charCodeAt(d++),!(61===l&&1<a));){if((l=s[l])===undefined$1)throw Error("invalid encoding");0===a?(p=l,a=1):1===a?(n[o++]=p<<2|(48&l)>>4,p=l,a=2):2===a?(n[o++]=(15&p)<<4|(60&l)>>2,p=l,a=3):3===a?(n[o++]=(3&p)<<6|l,a=0):void 0}if(1===a)throw Error("invalid encoding");return o-r},o.test=function(e){return /^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=)?$/.test(e)}},{}],3:[function(e,t){/**
...
// finish the function
if("string"!=typeof e){var t=i();if(n.verbose&&console.log("codegen: "+t),t="return "+t,e){for(var s=Object.keys(e),a=Array(s.length+1),d=Array(s.length),p=0;p<s.length;)a[p]=s[p],d[p]=e[s[p++]];return a[p]=t,Function.apply(null,a).apply(null,d);// eslint-disable-line no-new-func
}return Function(t)();// eslint-disable-line no-new-func
}// otherwise append to body
for(var l=Array(arguments.length-1),u=0;u<l.length;)l[u]=arguments[++u];if(u=0,e=e.replace(/%([%dfijs])/g,function(e,t){var n=l[u++];return"d"===t||"f"===t?+n+"":"i"===t?_Mathfloor(n)+"":"j"===t?JSON.stringify(n):"s"===t?n+"":"%"}),u!==l.length)throw Error("parameter count mismatch");return r.push(e),o}function i(n){return"function "+(n||t||"")+"("+(e&&e.join(",")||"")+"){\n  "+r.join("\n  ")+"\n}"}"string"==typeof e&&(t=e,e=undefined$1);var r=[];return o.toString=i,o}/**
         * Begins generating a function.
         * @memberof util
         * @function codegen
         * @param {string} [functionName] Function name if not anonymous
         ...
         * @type {boolean}
         */t.exports=n,n.verbose=!1},{}],4:[function(e,t){/**
         ...
         * @returns {undefined}
         */function n(e,t,i){return"function"==typeof t?(i=t,t={}):!t&&(t={}),i?!t.xhr&&r&&r.readFile?r.readFile(e,function(o,r){return o&&"undefined"!=typeof XMLHttpRequest?n.xhr(e,t,i):o?i(o):i(null,t.binary?r:r.toString("utf8"))}):n.xhr(e,t,i):o(n,this,e,t);// eslint-disable-line no-invalid-this
...
// use the XHR version otherwise.
         ...
         * @variation 3
         */ /**/t.exports=n;var o=e(1),i=e(7),r=i("fs");n.xhr=function(e,t,n){var o=new XMLHttpRequest;o.onreadystatechange/* works everywhere */=function(){if(4!==o.readyState)return undefined$1;// local cors security errors return status 0 / empty string, too. afaik this cannot be
...
if(t.binary){var e=o.response;if(!e){e=[];for(var r=0;r<o.responseText.length;++r)e.push(255&o.responseText.charCodeAt(r))}return n(null,"undefined"==typeof Uint8Array?e:new Uint8Array(e))}return n(null,o.responseText)},t.binary&&("overrideMimeType"in o&&o.overrideMimeType("text/plain; charset=x-user-defined"),o.responseType="arraybuffer"),o.open("GET",e),o.send()}},{1:1,7:7}],6:[function(e,t){/**
...
function n(e){var t=Math.LN2,n=Math.log;return"undefined"==typeof Float32Array?function(){function a(e,o,i,r){var s=0>o?1:0;if(s&&(o=-o),0===o)e(0<1/o?/* positive */0:/* negative 0 */2147483648,i,r);else if(isNaN(o))e(2143289344,i,r);else if(34028234663852886e22<o)// +-Infinity
e((2139095040|s<<31)>>>0,i,r);else if(11754943508222875e-54>o)// denormal
e((s<<31|_Mathround(o/1401298464324817e-60))>>>0,i,r);else{var a=_Mathfloor(n(o)/t),d=8388607&_Mathround(8388608*(o*_Mathpow(2,-a)));e((s<<31|a+127<<23|d)>>>0,i,r)}}function d(e,t,n){var o=e(t,n),i=2*(o>>31)+1,r=255&o>>>23,s=8388607&o;return 255==r?s?NaN:i*(1/0):0==r// denormal
?1401298464324817e-60*i*s:i*_Mathpow(2,r-150)*(s+8388608)}e.writeFloatLE=a.bind(null,o),e.writeFloatBE=a.bind(null,i),e.readFloatLE=d.bind(null,r),e.readFloatBE=d.bind(null,s)}():function(){function t(e,t,n){r[0]=e,t[n]=s[0],t[n+1]=s[1],t[n+2]=s[2],t[n+3]=s[3]}function n(e,t,n){r[0]=e,t[n]=s[3],t[n+1]=s[2],t[n+2]=s[1],t[n+3]=s[0]}/* istanbul ignore next */function o(e,t){return s[0]=e[t],s[1]=e[t+1],s[2]=e[t+2],s[3]=e[t+3],r[0]}function i(e,t){return s[3]=e[t],s[2]=e[t+1],s[1]=e[t+2],s[0]=e[t+3],r[0]}/* istanbul ignore next */var r=new Float32Array([-0]),s=new Uint8Array(r.buffer),a=128===s[3];e.writeFloatLE=a?t:n,e.writeFloatBE=a?n:t,e.readFloatLE=a?o:i,e.readFloatBE=a?i:o}(),"undefined"==typeof Float64Array?function(){function a(e,o,i,r,s,a){var d=0>r?1:0;if(d&&(r=-r),0===r)e(0,s,a+o),e(0<1/r?/* positive */0:/* negative 0 */2147483648,s,a+i);else if(isNaN(r))e(0,s,a+o),e(2146959360,s,a+i);else if(17976931348623157e292<r)e(0,s,a+o),e((2146435072|d<<31)>>>0,s,a+i);else{var p;if(22250738585072014e-324>r)p=r/5e-324,e(p>>>0,s,a+o),e((d<<31|p/4294967296)>>>0,s,a+i);else{var l=_Mathfloor(n(r)/t);1024===l&&(l=1023),p=r*_Mathpow(2,-l),e(4503599627370496*p>>>0,s,a+o),e((d<<31|l+1023<<20|1048575&1048576*p)>>>0,s,a+i)}}}function d(e,t,n,o,i){var r=e(o,i+t),s=e(o,i+n),a=2*(s>>31)+1,d=2047&s>>>20,p=4294967296*(1048575&s)+r;return 2047===d?p?NaN:a*(1/0):0===d// denormal
?5e-324*a*p:a*_Mathpow(2,d-1075)*(p+4503599627370496)}e.writeDoubleLE=a.bind(null,o,0,4),e.writeDoubleBE=a.bind(null,i,4,0),e.readDoubleLE=d.bind(null,r,0,4),e.readDoubleBE=d.bind(null,s,4,0)}():function(){function t(e,t,n){r[0]=e,t[n]=s[0],t[n+1]=s[1],t[n+2]=s[2],t[n+3]=s[3],t[n+4]=s[4],t[n+5]=s[5],t[n+6]=s[6],t[n+7]=s[7]}function n(e,t,n){r[0]=e,t[n]=s[7],t[n+1]=s[6],t[n+2]=s[5],t[n+3]=s[4],t[n+4]=s[3],t[n+5]=s[2],t[n+6]=s[1],t[n+7]=s[0]}/* istanbul ignore next */function o(e,t){return s[0]=e[t],s[1]=e[t+1],s[2]=e[t+2],s[3]=e[t+3],s[4]=e[t+4],s[5]=e[t+5],s[6]=e[t+6],s[7]=e[t+7],r[0]}function i(e,t){return s[7]=e[t],s[6]=e[t+1],s[5]=e[t+2],s[4]=e[t+3],s[3]=e[t+4],s[2]=e[t+5],s[1]=e[t+6],s[0]=e[t+7],r[0]}/* istanbul ignore next */var r=new Float64Array([-0]),s=new Uint8Array(r.buffer),a=128===s[7];e.writeDoubleLE=a?t:n,e.writeDoubleBE=a?n:t,e.readDoubleLE=a?o:i,e.readDoubleBE=a?i:o}(),e}// uint helpers
function o(e,t,n){t[n]=255&e,t[n+1]=255&e>>>8,t[n+2]=255&e>>>16,t[n+3]=e>>>24}function i(e,t,n){t[n]=e>>>24,t[n+1]=255&e>>>16,t[n+2]=255&e>>>8,t[n+3]=255&e}function r(e,t){return(e[t]|e[t+1]<<8|e[t+2]<<16|e[t+3]<<24)>>>0}function s(e,t){return(e[t]<<24|e[t+1]<<16|e[t+2]<<8|e[t+3])>>>0}t.exports=n(n)},{}],7:[function(require,module,exports){/**
...
if(mod&&(mod.length||Object.keys(mod).length))return mod}catch(t){}// eslint-disable-line no-empty
return null}module.exports=inquire},{}],8:[function(e,t,n){/**
         ...
         */o.resolve=function(e,t,n){return(n||(t=s(t)),r(t))?t:(n||(e=s(e)),(e=e.replace(/(?:\/|^)[^/]+$/,"")).length?s(e+"/"+t):t)}},{}],9:[function(e,t){/**
         ...
         */t.exports=function(e,t,n){var o=n||8192,i=null,r=o;return function(n){if(1>n||n>o>>>1)return e(n);r+n>o&&(i=e(o),r=0);var s=t.call(i,r,r+=n);return 7&r&&(// align to 32 bit
r=(7|r)+1),s}}},{}],10:[function(e,t,n){/**
         ...
         */o.length=function(e){for(var t=0,n=0,o=0;o<e.length;++o)n=e.charCodeAt(o),128>n?t+=1:2048>n?t+=2:55296==(64512&n)&&56320==(64512&e.charCodeAt(o+1))?(++o,t+=4):t+=3;return t},o.read=function(e,n,o){var r=o-n;if(1>r)return"";// temporary
for(var s=null,a=[],d=0,// char offset
p;n<o;)p=e[n++],128>p?a[d++]=p:191<p&&224>p?a[d++]=(31&p)<<6|63&e[n++]:239<p&&365>p?(p=((7&p)<<18|(63&e[n++])<<12|(63&e[n++])<<6|63&e[n++])-65536,a[d++]=55296+(p>>10),a[d++]=56320+(1023&p)):a[d++]=(15&p)<<12|(63&e[n++])<<6|63&e[n++],8191<d&&((s||(s=[])).push(_StringfromCharCode.apply(String,a)),d=0);return s?(d&&s.push(_StringfromCharCode.apply(String,a.slice(0,d))),s.join("")):_StringfromCharCode.apply(String,a.slice(0,d))},o.write=function(e,t,n){// character 2
for(var o=n,r=0,s,// character 1
a;r<e.length;++r)s=e.charCodeAt(r),128>s?t[n++]=s:2048>s?(t[n++]=192|s>>6,t[n++]=128|63&s):55296==(64512&s)&&56320==(64512&(a=e.charCodeAt(r+1)))?(s=65536+((1023&s)<<10)+(1023&a),++r,t[n++]=240|s>>18,t[n++]=128|63&s>>12,t[n++]=128|63&s>>6,t[n++]=128|63&s):(t[n++]=224|s>>12,t[n++]=128|63&s>>6,t[n++]=128|63&s);return n-o}},{}],11:[function(e,t){/**
...
t.exports=n;var o=/\/|\./;n("any",{/**
             ...
             * @memberof common
             */Any:{fields:{type_url:{type:"string",id:1},value:{type:"bytes",id:2}}}});var i;/**
         ...
         */n("duration",{/**
             ...
             * @memberof common
             */Duration:i={fields:{seconds:{type:"int64",id:1},nanos:{type:"int32",id:2}}}}),n("timestamp",{/**
             ...
             * @memberof common
             */ListValue:{fields:{values:{rule:"repeated",type:"Value",id:1}}}}),n("wrappers",{/**
             ...
             * @memberof common
             */BytesValue:{fields:{value:{type:"bytes",id:1}}}}),n("field_mask",{/**
             * Properties of a google.protobuf.FieldMask message.
             * @interface IDoubleValue
             * @type {Object}
             * @property {number} [value]
             * @memberof common
             */FieldMask:{fields:{paths:{rule:"repeated",type:"string",id:1}}}}),n.get=function(e){return n[e]||null}},{}],12:[function(e,t,n){/**
         ...
         * @ignore
         */function o(e,t,n,o){/* eslint-disable no-unexpected-multiline, block-scoped-var, no-redeclare */if(!t.resolvedType){var r=!1;switch(t.type){case"double":case"float":e("m%s=Number(d%s)",o,o);// also catches "NaN", "Infinity"
...
case"int64":case"sint64":case"fixed64":case"sfixed64":e("if(util.Long)")("(m%s=util.Long.fromValue(d%s)).unsigned=%j",o,o,r)("else if(typeof d%s===\"string\")",o)("m%s=parseInt(d%s,10)",o,o)("else if(typeof d%s===\"number\")",o)("m%s=d%s",o,o)("else if(typeof d%s===\"object\")",o)("m%s=new util.LongBits(d%s.low>>>0,d%s.high>>>0).toNumber(%s)",o,o,o,r?"true":"");break;case"bytes":e("if(typeof d%s===\"string\")",o)("util.base64.decode(d%s,m%s=util.newBuffer(util.base64.length(d%s)),0)",o,o,o)("else if(d%s.length)",o)("m%s=d%s",o,o);break;case"string":e("m%s=String(d%s)",o,o);break;case"bool":e("m%s=Boolean(d%s)",o,o);/* default: gen
         ...
         * @returns {Codegen} Codegen instance
         * @ignore
         */function r(e,t,n,o){/* eslint-disable no-unexpected-multiline, block-scoped-var, no-redeclare */if(t.resolvedType)t.resolvedType instanceof a?e("d%s=o.enums===String?types[%i].values[m%s]:m%s",o,n,o,o):e("d%s=types[%i].toObject(m%s,o)",o,n,o);else{var i=!1;switch(t.type){case"double":case"float":e("d%s=o.json&&!isFinite(m%s)?String(m%s):m%s",o,o,o,o);break;case"uint64":i=!0;// eslint-disable-line no-fallthrough
...
("d%s=o.longs===String?util.Long.prototype.toString.call(m%s):o.longs===Number?new util.LongBits(m%s.low>>>0,m%s.high>>>0).toNumber(%s):m%s",o,o,o,o,i?"true":"",o);break;case"bytes":e("d%s=o.bytes===String?util.base64.encode(m%s,0,m%s.length):o.bytes===Array?Array.prototype.slice.call(m%s):m%s",o,o,o,o,o);break;default:e("d%s=m%s",o,o);}}return e;/* eslint-enable no-unexpected-multiline, block-scoped-var, no-redeclare */}/**
         ...
         * @namespace
         */var s=n,a=e(15),d=e(37);s.fromObject=function(e){/* eslint-disable no-unexpected-multiline, block-scoped-var, no-redeclare */var t=e.fieldsArray,n=d.codegen(["d"],e.name+"$fromObject")("if(d instanceof this.ctor)")("return d");if(!t.length)return n("return new this.ctor");n("var m=new this.ctor");for(var r=0;r<t.length;++r){var s=t[r].resolve(),p=d.safeProp(s.name);// Map fields
...
("if(d%s!=null){",p),o(n,s,/* not sorted */r,p),!(s.resolvedType instanceof a)&&n("}"))}return n("return m");/* eslint-enable no-unexpected-multiline, block-scoped-var, no-redeclare */},s.toObject=function(e){/* eslint-disable no-unexpected-multiline, block-scoped-var, no-redeclare */var t=e.fieldsArray.slice().sort(d.compareFieldsById);if(!t.length)return d.codegen()("return {}");for(var n=d.codegen(["m","o"],e.name+"$toObject")("if(!o)")("o={}")("var d={}"),o=[],s=[],p=[],l=0;l<t.length;++l)t[l].partOf||(t[l].resolve().repeated?o:t[l].map?s:p).push(t[l]);if(o.length){for(n("if(o.arrays||o.defaults){"),l=0;l<o.length;++l)n("d%s=[]",d.safeProp(o[l].name));n("}")}if(s.length){for(n("if(o.objects||o.defaults){"),l=0;l<s.length;++l)n("d%s={}",d.safeProp(s[l].name));n("}")}if(p.length){for(n("if(o.defaults){"),l=0;l<p.length;++l){var u=p[l],y=d.safeProp(u.name);if(u.resolvedType instanceof a)n("d%s=o.enums===String?%j:%j",y,u.resolvedType.valuesById[u.typeDefault],u.typeDefault);else if(u.long)n("if(util.Long){")("var n=new util.Long(%i,%i,%j)",u.typeDefault.low,u.typeDefault.high,u.typeDefault.unsigned)("d%s=o.longs===String?n.toString():o.longs===Number?n.toNumber():n",y)("}else")("d%s=o.longs===String?%j:%i",y,u.typeDefault.toString(),u.typeDefault.toNumber());else if(u.bytes){var f="["+Array.prototype.slice.call(u.typeDefault).join(",")+"]";n("if(o.bytes===String)d%s=%j",y,_StringfromCharCode.apply(String,u.typeDefault))("else{")("d%s=%s",y,f)("if(o.bytes!==Array)d%s=util.newBuffer(d%s)",y,y)("}")}else n("d%s=%j",y,u.typeDefault);// also messages (=null)
}n("}")}var c=!1;for(l=0;l<t.length;++l){var u=t[l],m=e._fieldsArray.indexOf(u),y=d.safeProp(u.name);u.map?(!c&&(c=!0,n("var ks2")),n("if(m%s&&(ks2=Object.keys(m%s)).length){",y,y)("d%s={}",y)("for(var j=0;j<ks2.length;++j){"),r(n,u,/* sorted */m,y+"[ks2[j]]")("}")):u.repeated?(n("if(m%s&&m%s.length){",y,y)("d%s=[]",y)("for(var j=0;j<m%s.length;++j){",y),r(n,u,/* sorted */m,y+"[j]")("}")):(n("if(m%s!=null&&m.hasOwnProperty(%j)){",y,u.name),r(n,u,/* sorted */m,y),u.partOf&&n("if(o.oneofs)")("d%s=%j",d.safeProp(u.partOf.name),u.name)),n("}")}return n("return d");/* eslint-enable no-unexpected-multiline, block-scoped-var, no-redeclare */}},{15:15,37:37}],13:[function(e,t){function n(e){return"missing required '"+e.name+"'"}/**
         * Generates a decoder specific to the specified message type.
         * @param {Type} mtype Message type
         * @returns {Codegen} Codegen instance
         */t.exports=function(e){/* eslint-disable no-unexpected-multiline */var t=s.codegen(["r","l"],e.name+"$decode")("if(!(r instanceof Reader))")("r=Reader.create(r)")("var c=l===undefined?r.len:r.pos+l,m=new this.ctor"+(e.fieldsArray.filter(function(e){return e.map}).length?",k":""))("while(r.pos<c){")("var t=r.uint32()");e.group&&t("if((t&7)===4)")("break"),t("switch(t>>>3){");for(var a=0;a</* initializes */e.fieldsArray.length;++a){var d=e._fieldsArray[a].resolve(),p=d.resolvedType instanceof o?"int32":d.type,l="m"+s.safeProp(d.name);t("case %i:",d.id),d.map?(t("r.skip().pos++")// assumes id 1 + key wireType
...
t("%s[typeof k===\"object\"?util.longToHash(k):k]=r.%s()",l,p)):d.repeated?(t("if(!(%s&&%s.length))",l,l)("%s=[]",l),r.packed[p]!==undefined$1&&t("if((t&7)===2){")("var c2=r.uint32()+r.pos")("while(r.pos<c2)")("%s.push(r.%s())",l,p)("}else"),r.basic[p]===undefined$1?t(d.resolvedType.group?"%s.push(types[%i].decode(r))":"%s.push(types[%i].decode(r,r.uint32()))",l,a):t("%s.push(r.%s())",l,p)):r.basic[p]===undefined$1?t(d.resolvedType.group?"%s=types[%i].decode(r)":"%s=types[%i].decode(r,r.uint32())",l,a):t("%s=r.%s()",l,p),t("break")}// Field presence
for(t("default:")("r.skipType(t&7)")("break")("}")("}"),a=0;a<e._fieldsArray.length;++a){var u=e._fieldsArray[a];u.required&&t("if(!m.hasOwnProperty(%j))",u.name)("throw util.ProtocolError(%j,{instance:m})",n(u))}return t("return m");/* eslint-enable no-unexpected-multiline */};var o=e(15),r=e(36),s=e(37)},{15:15,36:36,37:37}],14:[function(e,t){/**
         ...
         * @param {Type} mtype Message type
         * @returns {Codegen} Codegen instance
         */t.exports=function(e){/* eslint-disable no-unexpected-multiline, block-scoped-var, no-redeclare */for(var t=s.codegen(["m","w"],e.name+"$encode")("if(!w)")("w=Writer.create()"),a=/* initializes */e.fieldsArray.slice().sort(s.compareFieldsById),d=0,d,p;d<a.length;++d){var l=a[d].resolve(),u=e._fieldsArray.indexOf(l),y=l.resolvedType instanceof o?"int32":l.type,f=r.basic[y];p="m"+s.safeProp(l.name),l.map?(t("if(%s!=null&&m.hasOwnProperty(%j)){",p,l.name)// !== undefined && !== null
...
t(".uint32(%i).%s(%s[ks[i]]).ldelim()",16|f,y,p),t("}")("}")):l.repeated?(t("if(%s!=null&&%s.length){",p,p),l.packed&&r.packed[y]!==undefined$1?t("w.uint32(%i).fork()",(2|l.id<<3)>>>0)("for(var i=0;i<%s.length;++i)",p)("w.%s(%s[i])",y,p)("w.ldelim()"):(t("for(var i=0;i<%s.length;++i)",p),f===undefined$1?n(t,l,u,p+"[i]"):t("w.uint32(%i).%s(%s[i])",(l.id<<3|f)>>>0,y,p)),t("}")):(l.optional&&t("if(%s!=null&&m.hasOwnProperty(%j))",p,l.name),f===undefined$1?n(t,l,u,p):t("w.uint32(%i).%s(%s)",(l.id<<3|f)>>>0,y,p))}return t("return w");/* eslint-enable no-unexpected-multiline, block-scoped-var, no-redeclare */};var o=e(15),r=e(36),s=e(37)},{15:15,36:36,37:37}],15:[function(e,t){/**
         ...
         */function n(e,t,n,r,s){if(o.call(this,e,n),t&&"object"!=typeof t)throw TypeError("values must be an object");/**
             * Enum values by id.
...
if(!r.isString(e))throw TypeError("name must be a string");if(!r.isInteger(t))throw TypeError("id must be an integer");if(this.values[e]!==undefined$1)throw Error("duplicate name '"+e+"' in "+this);if(this.isReservedId(t))throw Error("id "+t+" is reserved in "+this);if(this.isReservedName(e))throw Error("name '"+e+"' is reserved in "+this);if(this.valuesById[t]!==undefined$1){if(!(this.options&&this.options.allow_alias))throw Error("duplicate id "+t+" in "+this);this.values[e]=t}else this.valuesById[this.values[e]=t]=e;return this.comments[e]=n||null,this},n.prototype.remove=function(e){if(!r.isString(e))throw TypeError("name must be a string");var t=this.values[e];if(null==t)throw Error("name '"+e+"' does not exist in "+this);return delete this.valuesById[t],delete this.values[e],delete this.comments[e],this},n.prototype.isReservedId=function(e){return i.isReservedId(this.reserved,e)},n.prototype.isReservedName=function(e){return i.isReservedName(this.reserved,e)}},{23:23,24:24,37:37}],16:[function(e,t){/**
         ...
         */function n(e,t,n,i,d,p,l){if(s.isObject(i)?(l=d,p=i,i=d=undefined$1):s.isObject(d)&&(l=p,p=d,d=undefined$1),o.call(this,e,p),!s.isInteger(t)||0>t)throw TypeError("id must be a non-negative integer");if(!s.isString(n))throw TypeError("type must be a string");if(i!==undefined$1&&!a.test(i=i.toString().toLowerCase()))throw TypeError("rule must be a string rule");if(d!==undefined$1&&!s.isString(d))throw TypeError("extend must be a string");/**
             * Field rule, if any.
...
n.fromJSON=function(e,t){return new n(e,t.id,t.type,t.rule,t.extend,t.options,t.comment)},Object.defineProperty(n.prototype,"packed",{get:function(){return null===this._packed&&(this._packed=!1!==this.getOption("packed")),this._packed}}),n.prototype.setOption=function(e,t,n){return"packed"===e&&(// clear cached before setting
this._packed=null),o.prototype.setOption.call(this,e,t,n)},n.prototype.toJSON=function(e){var t=!!e&&!!e.keepComments;return s.toObject(["rule","optional"!==this.rule&&this.rule||undefined$1,"type",this.type,"id",this.id,"extend",this.extend,"options",this.options,"comment",t?this.comment:undefined$1])},n.prototype.resolve=function(){if(this.resolved)return this;// convert to internal data type if necesssary
...
return this.defaultValue=this.map?s.emptyObject:this.repeated?s.emptyArray:this.typeDefault,this.parent instanceof d&&(this.parent.ctor.prototype[this.name]=this.defaultValue),o.prototype.resolve.call(this)},n.d=function(e,t,o,i){return"function"==typeof t?t=s.decorateType(t).name:t&&"object"==typeof t&&(t=s.decorateEnum(t).name),function(r,a){s.decorateType(r.constructor).add(new n(a,e,t,o,{default:i}))}},n._configure=function(e){d=e}},{15:15,24:24,36:36,37:37}],17:[function(e,t){/**
...
var i=n;/**
         ...
         */ // Serialization
// Utility
i.build="minimal",i.Writer=e(42),i.BufferWriter=e(43),i.Reader=e(27),i.BufferReader=e(28),i.util=e(39),i.rpc=e(31),i.roots=e(30),i.configure=o,i.Writer._configure(i.BufferWriter),o()},{27:27,28:28,30:30,31:31,39:39,42:42,43:43}],19:[function(e,t){var n=t.exports=e(17);// Parser
// Configure parser
n.build="full",n.tokenize=e(34),n.parse=e(26),n.common=e(11),n.Root._configure(n.Type,n.parse,n.common)},{11:11,17:17,26:26,34:34}],20:[function(e,t){/**
...
var o=e(16);((n.prototype=Object.create(o.prototype)).constructor=n).className="MapField";var i=e(36),r=e(37);/**
         ...
         */n.fromJSON=function(e,t){return new n(e,t.id,t.keyType,t.type,t.options,t.comment)},n.prototype.toJSON=function(e){var t=!!e&&!!e.keepComments;return r.toObject(["keyType",this.keyType,"type",this.type,"id",this.id,"extend",this.extend,"options",this.options,"comment",t?this.comment:undefined$1])},n.prototype.resolve=function(){if(this.resolved)return this;// Besides a value type, map fields have a key type that may be "any scalar type except for floating point types and bytes"
if(i.mapKey[this.keyType]===undefined$1)throw Error("invalid key type: "+this.keyType);return o.prototype.resolve.call(this)},n.d=function(e,t,o){return"function"==typeof o?o=r.decorateType(o).name:o&&"object"==typeof o&&(o=r.decorateEnum(o).name),function(i,s){r.decorateType(i.constructor).add(new n(s,e,t,o))}}},{16:16,36:36,37:37}],21:[function(e,t){/**
...
/**
             ...
             * @private
             */s.call(this,e,t),this.nested=undefined$1,this._nestedArray=null}function r(e){return e._nestedArray=null,e}/**
...
/**
         ...
         */ // Sets up cyclic dependencies (called in index-light)
o.fromJSON=function(e,t){return new o(e,t.options).addJSON(t.nested)},o.arrayToJSON=n,o.isReservedId=function(e,t){if(e)for(var n=0;n<e.length;++n)if("string"!=typeof e[n]&&e[n][0]<=t&&e[n][1]>=t)return!0;return!1},o.isReservedName=function(e,t){if(e)for(var n=0;n<e.length;++n)if(e[n]===t)return!0;return!1},Object.defineProperty(o.prototype,"nestedArray",{get:function(){return this._nestedArray||(this._nestedArray=d.toArray(this.nested))}}),o.prototype.toJSON=function(e){return d.toObject(["options",this.options,"nested",n(this.nestedArray,e)])},o.prototype.addJSON=function(e){var t=this;/* istanbul ignore else */if(e)for(var n=Object.keys(e),r=0,s;r<n.length;++r)s=e[n[r]],t.add(// most to least likely
(s.fields===undefined$1?s.values===undefined$1?s.methods===undefined$1?s.id===undefined$1?o.fromJSON:a.fromJSON:l.fromJSON:u.fromJSON:p.fromJSON)(n[r],s));return this},o.prototype.get=function(e){return this.nested&&this.nested[e]||null},o.prototype.getEnum=function(e){if(this.nested&&this.nested[e]instanceof u)return this.nested[e].values;throw Error("no such enum: "+e)},o.prototype.add=function(e){if(!(e instanceof a&&e.extend!==undefined$1||e instanceof p||e instanceof u||e instanceof l||e instanceof o))throw TypeError("object must be a valid nested object");if(!this.nested)this.nested={};else{var t=this.get(e.name);if(t)if(t instanceof o&&e instanceof o&&!(t instanceof p||t instanceof l)){// replace plain namespace but keep existing nested elements and options
for(var n=t.nestedArray,s=0;s<n.length;++s)e.add(n[s]);this.remove(t),this.nested||(this.nested={}),e.setOptions(t.options,!0)}else throw Error("duplicate name '"+e.name+"' in "+this)}return this.nested[e.name]=e,e.onAdd(this),r(this)},o.prototype.remove=function(e){if(!(e instanceof s))throw TypeError("object must be a ReflectionObject");if(e.parent!==this)throw Error(e+" is not a member of "+this);return delete this.nested[e.name],Object.keys(this.nested).length||(this.nested=undefined$1),e.onRemove(this),r(this)},o.prototype.define=function(e,t){if(d.isString(e))e=e.split(".");else if(!Array.isArray(e))throw TypeError("illegal path");if(e&&e.length&&""===e[0])throw Error("path must be relative");for(var n=this,i;0<e.length;)if(i=e.shift(),!(n.nested&&n.nested[i]))n.add(n=new o(i));else if(n=n.nested[i],!(n instanceof o))throw Error("path conflicts with non-namespace objects");return t&&n.addJSON(t),n},o.prototype.resolveAll=function(){for(var e=this.nestedArray,t=0;t<e.length;)e[t]instanceof o?e[t++].resolveAll():e[t++].resolve();return this.resolve()},o.prototype.lookup=function(e,t,n){if("boolean"==typeof t?(n=t,t=undefined$1):t&&!Array.isArray(t)&&(t=[t]),d.isString(e)&&e.length){if("."===e)return this.root;e=e.split(".")}else if(!e.length)return this;// Start at root if path is absolute
...
return null===this.parent||n?null:this.parent.lookup(e,t)},o.prototype.lookupType=function(e){var t=this.lookup(e,[p]);if(!t)throw Error("no such type: "+e);return t},o.prototype.lookupEnum=function(e){var t=this.lookup(e,[u]);if(!t)throw Error("no such Enum '"+e+"' in "+this);return t},o.prototype.lookupTypeOrEnum=function(e){var t=this.lookup(e,[p,u]);if(!t)throw Error("no such Type or Enum '"+e+"' in "+this);return t},o.prototype.lookupService=function(e){var t=this.lookup(e,[l]);if(!t)throw Error("no such Service '"+e+"' in "+this);return t},o._configure=function(e,t,n){p=e,l=t,u=n}},{16:16,24:24,37:37}],24:[function(e,t){// cyclic
/**
         ...
         * @param {Object.<string,*>} [options] Declared options
         * @abstract
         */function n(e,t){if(!o.isString(e))throw TypeError("name must be a string");if(t&&!o.isObject(t))throw TypeError("options must be an object");/**
             * Options.
...
/**
             ...
             * Defining file name.
             * @type {string|null}
             */this.options=t,this.name=e,this.parent=null,this.resolved=!1,this.comment=null,this.filename=null}t.exports=n,n.className="ReflectionObject";var o=e(37),i;/**
...
Object.defineProperties(n.prototype,{/**
             ...
             * @type {string}
             * @readonly
             */fullName:{get:function(){for(var e=[this.name],t=this.parent;t;)e.unshift(t.name),t=t.parent;return e.join(".")}}}),n.prototype.toJSON=/* istanbul ignore next */function(){throw Error();// not implemented, shouldn't happen
},n.prototype.onAdd=function(e){this.parent&&this.parent!==e&&this.parent.remove(this),this.parent=e,this.resolved=!1;var t=e.root;t instanceof i&&t._handleAdd(this)},n.prototype.onRemove=function(e){var t=e.root;t instanceof i&&t._handleRemove(this),this.parent=null,this.resolved=!1},n.prototype.resolve=function(){return this.resolved?this:(this.root instanceof i&&(this.resolved=!0),this)},n.prototype.getOption=function(e){return this.options?this.options[e]:undefined$1},n.prototype.setOption=function(e,t,n){return n&&this.options&&this.options[e]!==undefined$1||((this.options||(this.options={}))[e]=t),this},n.prototype.setOptions=function(e,t){if(e)for(var n=Object.keys(e),o=0;o<n.length;++o)this.setOption(n[o],e[n[o]],t);return this},n.prototype.toString=function(){var e=this.constructor.className,t=this.fullName;return t.length?e+" "+t:e},n._configure=function(e){i=e}},{37:37}],25:[function(e,t){/**
...
this.oneof.splice(t,1),e.partOf=null,this},n.prototype.onAdd=function(e){r.prototype.onAdd.call(this,e);// Collect present fields
...
o(this)},n.prototype.onRemove=function(e){for(var t=0,n;t<this.fieldsArray.length;++t)(n=this.fieldsArray[t]).parent&&n.parent.remove(n);r.prototype.onRemove.call(this,e)},n.d=function(){for(var e=Array(arguments.length),t=0;t<arguments.length;)e[t]=arguments[t++];return function(t,o){a.decorateType(t.constructor).add(new n(o,e)),Object.defineProperty(t,o,{get:a.oneOfGetter(e),set:a.oneOfSetter(e)})}}},{16:16,24:24,37:37}],26:[function(e,t){/**
...
do{/* istanbul ignore if */if(!k.test(le=K()))throw S(le,"name");"{"===Z()?W(e,t+"."+le):(ee(":"),"{"===Z()?W(e,t+"."+le):X(e,t+"."+le,j(!0))),ee(",",!0)}while(!ee("}",!0));else X(e,t,j(!0));// Does not enforce a delimiter to be universal
         ...
         * @property {IParseOptions} defaults Default {@link IParseOptions}
         * @variation 2
         */t.exports=n,n.filename=null,n.defaults={keepCase:!1};var o=e(34),i=e(29),r=e(35),s=e(16),a=e(20),d=e(25),p=e(15),l=e(33),u=e(22),y=e(36),f=e(37),c=/^[1-9][0-9]*$/,m=/^-?[1-9][0-9]*$/,g=/^0[x][0-9a-fA-F]+$/,h=/^-?0[x][0-9a-fA-F]+$/,v=/^0[0-7]+$/,b=/^-?0[0-7]+$/,x=/^(?![eE])[0-9]*(?:\.[0-9]*)?(?:[eE][+-]?[0-9]+)?$/,k=/^[a-zA-Z_][a-zA-Z_0-9]*$/,A=/^(?:\.?[a-zA-Z_][a-zA-Z_0-9]*)(?:\.[a-zA-Z_][a-zA-Z_0-9]*)*$/,O=/^(?:\.[a-zA-Z_][a-zA-Z_0-9]*)+$/},{15:15,16:16,20:20,22:22,25:25,29:29,33:33,34:34,35:35,36:36,37:37}],27:[function(e,t){/* istanbul ignore next */function n(e,t){return RangeError("index out of range: "+e.pos+" + "+(t||1)+" > "+e.len)}/**
         ...
         */function o(e){/**
             ...
             * Read buffer length.
             * @type {number}
             */this.buf=e,this.pos=0,this.len=e.length}/* eslint-disable no-invalid-this */function i(){// tends to deopt with local vars for octet etc.
...
if(e.lo=(e.lo|(127&this.buf[this.pos])<<28)>>>0,e.hi=(e.hi|(127&this.buf[this.pos])>>4)>>>0,128>this.buf[this.pos++])return e;t=0}else{for(;3>t;++t){/* istanbul ignore if */if(this.pos>=this.len)throw n(this);// 1st..3th
if(e.lo=(e.lo|(127&this.buf[this.pos])<<7*t)>>>0,128>this.buf[this.pos++])return e}// 4th
return e.lo=(e.lo|(127&this.buf[this.pos++])<<7*t)>>>0,e}if(4<this.len-this.pos){// fast route (hi)
for(;5>t;++t)if(e.hi=(e.hi|(127&this.buf[this.pos])<<7*t+3)>>>0,128>this.buf[this.pos++])return e;}else for(;5>t;++t){/* istanbul ignore if */if(this.pos>=this.len)throw n(this);// 6th..10th
if(e.hi=(e.hi|(127&this.buf[this.pos])<<7*t+3)>>>0,128>this.buf[this.pos++])return e}/* istanbul ignore next */throw Error("invalid varint encoding")}/* eslint-enable no-invalid-this */ /**
...
return(e[t-4]|e[t-3]<<8|e[t-2]<<16|e[t-1]<<24)>>>0}/**
         ...
         * @returns {Reader} `this`
         */o.create=a.Buffer?function(e){return(o.create=function(e){return a.Buffer.isBuffer(e)?new u(e)/* istanbul ignore next */:l(e)})(e)}/* istanbul ignore next */:l,o.prototype._slice=a.Array.prototype.subarray||/* istanbul ignore next */a.Array.prototype.slice,o.prototype.uint32=function(){var e=4294967295;// optimizer type-hint, tends to deopt otherwise (?!)
return function(){if(e=(127&this.buf[this.pos])>>>0,128>this.buf[this.pos++])return e;if(e=(e|(127&this.buf[this.pos])<<7)>>>0,128>this.buf[this.pos++])return e;if(e=(e|(127&this.buf[this.pos])<<14)>>>0,128>this.buf[this.pos++])return e;if(e=(e|(127&this.buf[this.pos])<<21)>>>0,128>this.buf[this.pos++])return e;if(e=(e|(15&this.buf[this.pos])<<28)>>>0,128>this.buf[this.pos++])return e;/* istanbul ignore if */if((this.pos+=5)>this.len)throw this.pos=this.len,n(this,10);return e}}(),o.prototype.int32=function(){return 0|this.uint32()},o.prototype.sint32=function(){var e=this.uint32();return 0|e>>>1^-(1&e)},o.prototype.bool=function(){return 0!==this.uint32()},o.prototype.fixed32=function(){/* istanbul ignore if */if(this.pos+4>this.len)throw n(this,4);return r(this.buf,this.pos+=4)},o.prototype.sfixed32=function(){/* istanbul ignore if */if(this.pos+4>this.len)throw n(this,4);return 0|r(this.buf,this.pos+=4)},o.prototype.float=function(){/* istanbul ignore if */if(this.pos+4>this.len)throw n(this,4);var e=a.float.readFloatLE(this.buf,this.pos);return this.pos+=4,e},o.prototype.double=function(){/* istanbul ignore if */if(this.pos+8>this.len)throw n(this,4);var e=a.float.readDoubleLE(this.buf,this.pos);return this.pos+=8,e},o.prototype.bytes=function(){var e=this.uint32(),t=this.pos,o=this.pos+e;/* istanbul ignore if */if(o>this.len)throw n(this,e);return this.pos+=e,Array.isArray(this.buf)?this.buf.slice(t,o):t===o// fix for IE 10/Win8 and others' subarray returning array of size 1
?new this.buf.constructor(0):this._slice.call(this.buf,t,o)},o.prototype.string=function(){var e=this.bytes();return p.read(e,0,e.length)},o.prototype.skip=function(e){if("number"==typeof e){/* istanbul ignore if */if(this.pos+e>this.len)throw n(this,e);this.pos+=e}else do/* istanbul ignore if */if(this.pos>=this.len)throw n(this);while(128&this.buf[this.pos++]);return this},o.prototype.skipType=function(e){switch(e){case 0:this.skip();break;case 1:this.skip(8);break;case 2:this.skip(this.uint32());break;case 3:for(;4!=(e=7&this.uint32());)this.skipType(e);break;case 5:this.skip(4);break;/* istanbul ignore next */default:throw Error("invalid wire type "+e+" at offset "+this.pos);}return this},o._configure=function(e){u=e;var t=a.Long?"toLong":/* istanbul ignore next */"toNumber";a.merge(o.prototype,{int64:function(){return i.call(this)[t](!1)},uint64:function(){return i.call(this)[t](!0)},sint64:function(){return i.call(this).zzDecode()[t](!1)},fixed64:function(){return s.call(this)[t](!0)},sfixed64:function(){return s.call(this)[t](!1)}})}},{39:39}],28:[function(e,t){/**
...
var o=e(27);(n.prototype=Object.create(o.prototype)).constructor=n;var i=e(39);/**
         * @override
         */i.Buffer&&(n.prototype._slice=i.Buffer.prototype.slice),n.prototype.string=function(){var e=this.uint32();// modifies pos
return this.buf.utf8Slice(this.pos,this.pos=_Mathmin(this.pos+e,this.len))}},{27:27,39:39}],29:[function(e,t){// "
/**
...
function a(e,t){try{if(l.isString(t)&&"{"===t.charAt(0)&&(t=JSON.parse(t)),!l.isString(t))p.setOptions(t.options).addJSON(t.nested);else{y.filename=e;var o=y(t,p,n),r=0,a;if(o.imports)for(;r<o.imports.length;++r)(a=p.resolvePath(e,o.imports[r]))&&d(a);if(o.weakImports)for(r=0;r<o.weakImports.length;++r)(a=p.resolvePath(e,o.weakImports[r]))&&d(a,!0)}}catch(e){s(e)}u||c||s(null,p)}// Fetches a single file
...
if(p.files.push(e),e in f)return void(u?a(e,f[e]):(++c,setTimeout(function(){--c,a(e,f[e])})));// Otherwise fetch from disk or network
if(u){var i;try{i=l.fs.readFileSync(e).toString("utf8")}catch(e){return void(t||s(e))}a(e,i)}else++c,l.fetch(e,function(n,o){/* istanbul ignore if */return--c,r?n?void(t?!c&&// can't be covered reliably
s(null,p):s(n)):void a(e,o):void 0;// terminated meanwhile
})}}"function"==typeof n&&(r=n,n=undefined$1);var p=this;if(!r)return l.asPromise(e,p,t,n);var u=r===o,c=0;l.isString(t)&&(t=[t]);for(var m=0,g;m<t.length;++m)(g=p.resolvePath("",t[m]))&&d(g);return u?p:(c||s(null,p),undefined$1)},n.prototype.loadSync=function(e,t){if(!l.isNode)throw Error("not supported");return this.load(e,t,o)},n.prototype.resolveAll=function(){if(this.deferred.length)throw Error("unresolvable extensions: "+this.deferred.map(function(e){return"'extend "+e.extend+"' in "+e.parent.fullName}).join(", "));return s.prototype.resolveAll.call(this)};// only uppercased (and thus conflict-free) children are exposed, see below
var c=/^[A-Z]/;/**
         ...
         * @private
         */ // Sets up cyclic dependencies (called in index-light)
n.prototype._handleAdd=function(e){if(e instanceof a)/* an extension field (implies not part of a oneof) */e.extend===undefined$1||e.extensionField||r(this,e)||this.deferred.push(e);else if(e instanceof d)c.test(e.name)&&(e.parent[e.name]=e.values);else if(!(e instanceof p))/* everything else is a namespace */{if(e instanceof u)// Try to handle any deferred extensions
...
this._handleAdd(e._nestedArray[n]);c.test(e.name)&&(e.parent[e.name]=e)}// The above also adds uppercased (and thus conflict-free) nested types, services and enums as
// properties of namespaces just like static code does. This allows using a .d.ts generated for
// a static module with reflection-based solutions where the condition is met.
},n.prototype._handleRemove=function(e){if(e instanceof a){if(/* an extension field */e.extend!==undefined$1)if(/* already handled */e.extensionField)// remove its sister field
e.extensionField.parent.remove(e.extensionField),e.extensionField=null;else{// cancel the extension
var t=this.deferred.indexOf(e);/* istanbul ignore else */-1<t&&this.deferred.splice(t,1)}}else if(e instanceof d)c.test(e.name)&&delete e.parent[e.name];else if(e instanceof s){for(var n=0;n</* initializes */e.nestedArray.length;++n)// recurse into the namespace
this._handleRemove(e._nestedArray[n]);c.test(e.name)&&delete e.parent[e.name]}},n._configure=function(e,t,n){u=e,y=t,f=n}},{15:15,16:16,23:23,25:25,37:37}],30:[function(e,t){t.exports={}},{}],31:[function(e,t,n){/**
         ...
         * @returns {undefined}
         */n.Service=e(32)},{32:32}],32:[function(e,t){/**
         ...
         */function n(e,t,n){if("function"!=typeof e)throw TypeError("rpcImpl must be a function");/**
...
var r=e(23);((n.prototype=Object.create(r.prototype)).constructor=n).className="Service";var s=e(22),a=e(37),d=e(31);/**
         ...
         */function o(e,t){/* istanbul ignore next */ /**
             ...
             * @returns {undefined}
             * @inner
             */function f(n,o){O=e.charAt(n++),S=A,I=!1;var r=t?2:3;var s=n-r,l;do if(0>--s||"\n"===(l=e.charAt(s))){I=!0;break}while(" "===l||"\t"===l);for(var u=e.substring(n,o).split(p),y=0;y<u.length;++y)u[y]=u[y].replace(t?d:a,"").trim();E=u.join("\n").trim()}function c(t){var n=m(t),o=e.substring(t,n),i=/^\s*\/{1,2}/.test(o);// see if remaining line matches comment pattern
return i}function m(e){// find end of cursor's line
for(var t=e;t<k&&"\n"!==y(t);)t++;return t}/**
             * Obtains the next token.
             * @returns {string|null} Next token or `null` on eof
             * @inner
             */function g(){if(0<j.length)return j.shift();if(T)return u();var n,r,s,a,d;do{if(x===k)return null;for(n=!1;l.test(s=y(x));)if("\n"===s&&++A,++x===k)return null;if("/"===y(x)){if(++x===k)throw o("comment");if("/"===y(x)){// Line
if(!t){for(d="/"===y(a=x+1);"\n"!==y(++x);)if(x===k)return null;++x,d&&f(a,x-1),++A,n=!0}else{if(a=x,d=!1,c(x)){d=!0;do{if(x=m(x),x===k)break;x++}while(c(x))}else x=_Mathmin(k,m(x)+1);d&&f(a,x),A++,n=!0}}else if("*"===(s=y(x))){a=x+1,d=t||"*"===y(a);do{if("\n"===s&&++A,++x===k)throw o("comment");r=s,s=y(x)}while("*"!==r||"/"!==s);++x,d&&f(a,x-2),n=!0}else return"/"}}while(n);// offset !== length if we got here
var p=x;i.lastIndex=0;var g=i.test(y(p++));if(!g)for(;p<k&&!i.test(y(p));)++p;var h=e.substring(x,x=p);return("\""===h||"'"===h)&&(T=h),h}/**
             ...
             * @inner
             */function b(e){var n=null;return e===undefined$1?S===A-1&&(t||"*"===O||I)&&(n=E):(S<e&&v(),S===e&&!I&&(t||"/"===O)&&(n=E)),n}e=e.toString();var x=0,k=e.length,A=1,O=null,E=null,S=0,I=!1,j=[],T=null;return Object.defineProperty({next:g,peek:v,push:h,skip:function(e,t){var n=v();if(n===e)return g(),!0;if(!t)throw o("token '"+n+"', '"+e+"' expected");return!1},cmnt:b},"line",{get:function(){return A}});/* eslint-enable callback-return */}t.exports=o;var i=/[\s{}=;:[\],'"()<>]/g,r=/(?:"([^"\\]*(?:\\.[^"\\]*)*)")/g,s=/(?:'([^'\\]*(?:\\.[^'\\]*)*)')/g,a=/^ *[*/]+ */,d=/^\s*\*?\/*/,p=/\n/g,l=/\s/,u=/\\(.?)/g,y={0:"\0",r:"\r",n:"\n",t:"\t"};o.unescape=n},{}],35:[function(e,t){/**
...
/**
         ...
         */t.exports=n;// extends Namespace
var r=e(23);((n.prototype=Object.create(r.prototype)).constructor=n).className="Type";var s=e(15),a=e(25),d=e(16),p=e(20),l=e(33),u=e(21),y=e(27),f=e(42),c=e(37),m=e(14),g=e(13),h=e(40),v=e(12),b=e(41);/**
         ...
         */Object.defineProperties(n.prototype,{/**
             ...
             * @type {Field[]}
             * @readonly
             */fieldsArray:{get:function(){return this._fieldsArray||(this._fieldsArray=c.toArray(this.fields))}},/**
             * Oneofs of this message as an array for iteration.
             * @name Type#oneofsArray
             * @type {OneOf[]}
             * @readonly
             */oneofsArray:{get:function(){return this._oneofsArray||(this._oneofsArray=c.toArray(this.oneofs))}},/**
             * The registered constructor, if any registered, otherwise a generic constructor.
             * Assigning a function replaces the internal constructor. If the function does not extend {@link Message} yet, its prototype will be setup accordingly and static methods will be populated. If it already extends {@link Message}, it will just replace the internal constructor.
             * @name Type#ctor
             * @type {Constructor<{}>}
             */ctor:{get:function(){return this._ctor||(this.ctor=n.generateConstructor(this)())},set:function(e){// Ensure proper prototype
var t=e.prototype;t instanceof u||((e.prototype=new u).constructor=e,c.merge(e.prototype,t)),e.$type=e.prototype.$type=this,c.merge(e,u,!0),this._ctor=e;for(// Messages have non-enumerable default values on their prototype
var n=0;n</* initializes */this.fieldsArray.length;++n)this._fieldsArray[n].resolve();// ensures a proper value
// Messages have non-enumerable getters and setters for each virtual oneof field
var o={};for(n=0;n</* initializes */this.oneofsArray.length;++n)o[this._oneofsArray[n].resolve().name]={get:c.oneOfGetter(this._oneofsArray[n].oneof),set:c.oneOfSetter(this._oneofsArray[n].oneof)};n&&Object.defineProperties(e.prototype,o)}}}),n.generateConstructor=function(e){/* eslint-disable no-unexpected-multiline */ // explicitly initialize mutable object/array fields so that these aren't just inherited from the prototype
for(var t=c.codegen(["p"],e.name),n=0,o;n<e.fieldsArray.length;++n)(o=e._fieldsArray[n]).map?t("this%s={}",c.safeProp(o.name)):o.repeated&&t("this%s=[]",c.safeProp(o.name));return t("if(p)for(var ks=Object.keys(p),i=0;i<ks.length;++i)if(p[ks[i]]!=null)")// omit undefined or null
("this[ks[i]]=p[ks[i]]");/* eslint-enable no-unexpected-multiline */},n.fromJSON=function(e,t){var o=new n(e,t.options);o.extensions=t.extensions,o.reserved=t.reserved;for(var u=Object.keys(t.fields),y=0;y<u.length;++y)o.add(("undefined"==typeof t.fields[u[y]].keyType?d.fromJSON:p.fromJSON)(u[y],t.fields[u[y]]));if(t.oneofs)for(u=Object.keys(t.oneofs),y=0;y<u.length;++y)o.add(a.fromJSON(u[y],t.oneofs[u[y]]));if(t.nested)for(u=Object.keys(t.nested),y=0;y<u.length;++y){var f=t.nested[u[y]];o.add(// most to least likely
(f.id===undefined$1?f.fields===undefined$1?f.values===undefined$1?f.methods===undefined$1?r.fromJSON:l.fromJSON:s.fromJSON:n.fromJSON:d.fromJSON)(u[y],f))}return t.extensions&&t.extensions.length&&(o.extensions=t.extensions),t.reserved&&t.reserved.length&&(o.reserved=t.reserved),t.group&&(o.group=!0),t.comment&&(o.comment=t.comment),o},n.prototype.toJSON=function(e){var t=r.prototype.toJSON.call(this,e),n=!!e&&!!e.keepComments;return c.toObject(["options",t&&t.options||undefined$1,"oneofs",r.arrayToJSON(this.oneofsArray,e),"fields",r.arrayToJSON(this.fieldsArray.filter(function(e){return!e.declaringField}),e)||{},"extensions",this.extensions&&this.extensions.length?this.extensions:undefined$1,"reserved",this.reserved&&this.reserved.length?this.reserved:undefined$1,"group",this.group||undefined$1,"nested",t&&t.nested||undefined$1,"comment",n?this.comment:undefined$1])},n.prototype.resolveAll=function(){for(var e=this.fieldsArray,t=0;t<e.length;)e[t++].resolve();var n=this.oneofsArray;for(t=0;t<n.length;)n[t++].resolve();return r.prototype.resolveAll.call(this)},n.prototype.get=function(e){return this.fields[e]||this.oneofs&&this.oneofs[e]||this.nested&&this.nested[e]||null},n.prototype.add=function(e){if(this.get(e.name))throw Error("duplicate name '"+e.name+"' in "+this);if(e instanceof d&&e.extend===undefined$1){// NOTE: Extension fields aren't actual fields on the declaring type, but nested objects.
// The root object takes care of adding distinct sister-fields to the respective extended
// type instead.
// avoids calling the getter if not absolutely necessary because it's called quite frequently
if(this._fieldsById?/* istanbul ignore next */this._fieldsById[e.id]:this.fieldsById[e.id])throw Error("duplicate id "+e.id+" in "+this);if(this.isReservedId(e.id))throw Error("id "+e.id+" is reserved in "+this);if(this.isReservedName(e.name))throw Error("name '"+e.name+"' is reserved in "+this);return e.parent&&e.parent.remove(e),this.fields[e.name]=e,e.message=this,e.onAdd(this),o(this)}return e instanceof a?(this.oneofs||(this.oneofs={}),this.oneofs[e.name]=e,e.onAdd(this),o(this)):r.prototype.add.call(this,e)},n.prototype.remove=function(e){if(e instanceof d&&e.extend===undefined$1){// See Type#add for the reason why extension fields are excluded here.
/* istanbul ignore if */if(!this.fields||this.fields[e.name]!==e)throw Error(e+" is not a member of "+this);return delete this.fields[e.name],e.parent=null,e.onRemove(this),o(this)}if(e instanceof a){/* istanbul ignore if */if(!this.oneofs||this.oneofs[e.name]!==e)throw Error(e+" is not a member of "+this);return delete this.oneofs[e.name],e.parent=null,e.onRemove(this),o(this)}return r.prototype.remove.call(this,e)},n.prototype.isReservedId=function(e){return r.isReservedId(this.reserved,e)},n.prototype.isReservedName=function(e){return r.isReservedName(this.reserved,e)},n.prototype.create=function(e){return new this.ctor(e)},n.prototype.setup=function(){// Sets up everything at once so that the prototype chain does not have to be re-evaluated
...
this.encode=m(this)({Writer:f,types:t,util:c}),this.decode=g(this)({Reader:y,types:t,util:c}),this.verify=h(this)({types:t,util:c}),this.fromObject=v.fromObject(this)({types:t,util:c}),this.toObject=v.toObject(this)({types:t,util:c});// Inject custom wrappers for common types
var o=b[e];if(o){var r=Object.create(this);// if (wrapper.fromObject) {
// }
// if (wrapper.toObject) {
r.fromObject=this.fromObject,this.fromObject=o.fromObject.bind(r),r.toObject=this.toObject,this.toObject=o.toObject.bind(r)}return this},n.prototype.encode=function(e,t){return this.setup().encode(e,t);// overrides this method
},n.prototype.encodeDelimited=function(e,t){return this.encode(e,t&&t.len?t.fork():t).ldelim()},n.prototype.decode=function(e,t){return this.setup().decode(e,t);// overrides this method
},n.prototype.decodeDelimited=function(e){return e instanceof y||(e=y.create(e)),this.decode(e,e.uint32())},n.prototype.verify=function(e){return this.setup().verify(e);// overrides this method
},n.prototype.fromObject=function(e){return this.setup().fromObject(e)},n.prototype.toObject=function(e,t){return this.setup().toObject(e,t)},n.d=function(e){return function(t){c.decorateType(t,e)}}},{12:12,13:13,14:14,15:15,16:16,20:20,21:21,23:23,25:25,27:27,33:33,37:37,40:40,41:41,42:42}],36:[function(e,t,n){function o(e,t){var n=0,r={};for(t|=0;n<e.length;)r[a[n+t]]=e[n++];return r}/**
...
r;n.codegen=e(3),n.fetch=e(5),n.path=e(8),n.fs=n.inquire("fs"),n.toArray=function(e){if(e){for(var t=Object.keys(e),n=Array(t.length),o=0;o<t.length;)n[o]=e[t[o++]];return n}return[]},n.toObject=function(e){for(var t={},n=0;n<e.length;){var o=e[n++],i=e[n++];i!==undefined$1&&(t[o]=i)}return t};var s=/\\/g,a=/"/g;/**
         ...
         * @type {Root}
         * @readonly
         */n.decorateEnum=function(t){/* istanbul ignore if */if(t.$type)return t.$type;/* istanbul ignore next */r||(r=e(15));var o=new r("Enum"+p++,t);return n.decorateRoot.add(o),Object.defineProperty(t,"$type",{value:o,enumerable:!1}),o},Object.defineProperty(n,"decorateRoot",{get:function(){return o.decorated||(o.decorated=new(e(29)))}})},{15:15,29:29,3:3,30:30,35:35,39:39,5:5,8:8}],38:[function(e,t){/**
...
for(var o=Object.keys(t),r=0;r<o.length;++r)e[o[r]]!==undefined$1&&n||(e[o[r]]=t[o[r]]);return e}/**
         ...
         */function i(e){function t(e,n){return this instanceof t?void(// Error.call(this, message);
// ^ just returns a new error instance because the ctor can be called as a function
Object.defineProperty(this,"message",{get:function(){return e}}),Error.captureStackTrace?// node
Error.captureStackTrace(this,t):Object.defineProperty(this,"stack",{value:new Error().stack||""}),n&&o(this,n)):new t(e,n)}return(t.prototype=Object.create(Error.prototype)).constructor=t,Object.defineProperty(t.prototype,"name",{get:function(){return e}}),t.prototype.toString=function(){return this.name+": "+this.message},t}var r=n;// used to return a Promise where callback is omitted
...
r.asPromise=e(1),r.base64=e(2),r.EventEmitter=e(4),r.float=e(6),r.inquire=e(7),r.utf8=e(10),r.pool=e(9),r.LongBits=e(38),r.global="undefined"!=typeof window&&window||"undefined"!=typeof global&&global||"undefined"!=typeof self&&self||this,r.emptyArray=Object.freeze?Object.freeze([]):/* istanbul ignore next */[],r.emptyObject=Object.freeze?Object.freeze({}):/* istanbul ignore next */{},r.isNode=!!(r.global.process&&r.global.process.versions&&r.global.process.versions.node),r.isInteger=Number.isInteger||/* istanbul ignore next */function(e){return"number"==typeof e&&isFinite(e)&&_Mathfloor(e)===e},r.isString=function(e){return"string"==typeof e||e instanceof String},r.isObject=function(e){return e&&"object"==typeof e},r.isset=/**
             ...
             * @param {string} prop Property name
             * @returns {boolean} `true` if considered to be present, otherwise `false`
             */r.isSet=function(e,t){var n=e[t];return!!(null!=n&&e.hasOwnProperty(t))&&("object"!=typeof n||0<(Array.isArray(n)?n.length:Object.keys(n).length))},r.Buffer=function(){try{var e=r.inquire("buffer").Buffer;// refuse to use non-node buffers if not explicitly assigned (perf reasons):
return e.prototype.utf8Write?e:/* istanbul ignore next */null}catch(t){/* istanbul ignore next */return null}}(),r._Buffer_from=null,r._Buffer_allocUnsafe=null,r.newBuffer=function(e){/* istanbul ignore next */return"number"==typeof e?r.Buffer?r._Buffer_allocUnsafe(e):new r.Array(e):r.Buffer?r._Buffer_from(e):"undefined"==typeof Uint8Array?e:new Uint8Array(e)},r.Array="undefined"==typeof Uint8Array?/* istanbul ignore next */Array:Uint8Array,r.Long=/* istanbul ignore next */r.global.dcodeIO&&/* istanbul ignore next */r.global.dcodeIO.Long||/* istanbul ignore next */r.global.Long||r.inquire("long"),r.key2Re=/^true|false|0|1$/,r.key32Re=/^-?(?:0|[1-9][0-9]*)$/,r.key64Re=/^(?:[\\x00-\\xff]{8}|-?(?:0|[1-9][0-9]*))$/,r.longToHash=function(e){return e?r.LongBits.from(e).toHash():r.LongBits.zeroHash},r.longFromHash=function(e,t){var n=r.LongBits.fromHash(e);return r.Long?r.Long.fromBits(n.lo,n.hi,t):n.toNumber(!!t)},r.merge=o,r.lcFirst=function(e){return e.charAt(0).toLowerCase()+e.substring(1)},r.newError=i,r.ProtocolError=i("ProtocolError"),r.oneOfGetter=function(e){for(var t={},n=0;n<e.length;++n)t[e[n]]=1;/**
             * @returns {string|undefined} Set field name, if any
             * @this Object
             * @ignore
             */return function(){// eslint-disable-line consistent-return
for(var e=Object.keys(this),n=e.length-1;-1<n;--n)if(1===t[e[n]]&&this[e[n]]!==undefined$1&&null!==this[e[n]])return e[n]}},r.oneOfSetter=function(e){/**
             * @param {string} name Field name
             * @returns {undefined}
             * @this Object
             * @ignore
             */return function(t){for(var n=0;n<e.length;++n)e[n]!==t&&delete this[e[n]]}},r.toJSONOptions={longs:String,enums:String,bytes:String,json:!0},r._configure=function(){var e=r.Buffer;/* istanbul ignore if */return e?void(// because node 4.x buffers are incompatible & immutable
// see: https://github.com/dcodeIO/protobuf.js/pull/665
r._Buffer_from=e.from!==Uint8Array.from&&e.from||/* istanbul ignore next */function(t,n){return new e(t,n)},r._Buffer_allocUnsafe=e.allocUnsafe||/* istanbul ignore next */function(t){return new e(t)}):void(r._Buffer_from=r._Buffer_allocUnsafe=null)}},{1:1,10:10,2:2,38:38,4:4,6:6,7:7,9:9}],40:[function(e,t){function n(e,t){return e.name+": "+t+(e.repeated&&"array"!==t?"[]":e.map&&"object"!==t?"{k:"+e.keyType+"}":"")+" expected"}/**
         ...
         * @returns {Codegen} Codegen instance
         * @ignore
         */function r(e,t,o){/* eslint-disable no-unexpected-multiline */switch(t.keyType){case"int32":case"uint32":case"sint32":case"fixed32":case"sfixed32":e("if(!util.key32Re.test(%s))",o)("return%j",n(t,"integer key"));break;case"int64":case"uint64":case"sint64":case"fixed64":case"sfixed64":e("if(!util.key64Re.test(%s))",o)// see comment above: x is ok, d is not
("return%j",n(t,"integer|Long key"));break;case"bool":e("if(!util.key2Re.test(%s))",o)("return%j",n(t,"boolean key"));}return e;/* eslint-enable no-unexpected-multiline */}/**
         * Generates a verifier specific to the specified message type.
         * @param {Type} mtype Message type
         * @returns {Codegen} Codegen instance
         */t.exports=function(e){/* eslint-disable no-unexpected-multiline */var t=a.codegen(["m"],e.name+"$verify")("if(typeof m!==\"object\"||m===null)")("return%j","object expected"),s=e.oneofsArray,d={};s.length&&t("var p={}");for(var p=0;p</* initializes */e.fieldsArray.length;++p){var l=e._fieldsArray[p].resolve(),u="m"+a.safeProp(l.name);// !== undefined && !== null
// map fields
if(l.optional&&t("if(%s!=null&&m.hasOwnProperty(%j)){",u,l.name),l.map)t("if(!util.isObject(%s))",u)("return%j",n(l,"object"))("var k=Object.keys(%s)",u)("for(var i=0;i<k.length;++i){"),r(t,l,"k[i]"),o(t,l,p,u+"[k[i]]")("}");else if(l.repeated)t("if(!Array.isArray(%s))",u)("return%j",n(l,"array"))("for(var i=0;i<%s.length;++i){",u),o(t,l,p,u+"[i]")("}");else{if(l.partOf){var y=a.safeProp(l.partOf.name);1===d[l.partOf.name]&&t("if(p%s===1)",y)("return%j",l.partOf.name+": multiple values"),d[l.partOf.name]=1,t("p%s=1",y)}o(t,l,p,u)}l.optional&&t("}")}return t("return null");/* eslint-enable no-unexpected-multiline */};var s=e(15),a=e(37)},{15:15,37:37}],41:[function(e,t,n){/**
...
n[".google.protobuf.Any"]={fromObject:function(e){// unwrap value type if mapped
if(e&&e["@type"]){var t=this.lookup(e["@type"]);/* istanbul ignore else */if(t){// type_url does not accept leading "."
var n="."===e["@type"].charAt(0)?e["@type"].substr(1):e["@type"];// type_url prefix is optional, but path seperator is required
return this.create({type_url:"/"+n,value:t.encode(t.fromObject(e)).finish()})}}return this.fromObject(e)},toObject:function(e,t){// decode value if requested and unmapped
if(t&&t.json&&e.type_url&&e.value){// Only use fully qualified type name after the last '/'
var n=e.type_url.substring(e.type_url.lastIndexOf("/")+1),i=this.lookup(n);i&&(e=i.decode(e.value))}// wrap value if unmapped
if(!(e instanceof this.ctor)&&e instanceof o){var r=e.$type.toObject(e,t);return r["@type"]=e.$type.fullName,r}return this.toObject(e,t)}}},{21:21}],42:[function(e,t){/**
         ...
         */function n(e,t,n){/**
             ...
             * Value to write.
             * @type {*}
             */this.fn=e,this.len=t,this.next=undefined$1,this.val=n}/* istanbul ignore next */function o(){}// eslint-disable-line no-empty-function
/**
         ...
         * @returns {Writer} `this`
         */t.exports=r;var l=e(39),u=l.LongBits,y=l.base64,f=l.utf8,c;r.create=l.Buffer?function(){return(r.create=function(){return new c})()}/* istanbul ignore next */:function(){return new r},r.alloc=function(e){return new l.Array(e)},l.Array!==Array&&(r.alloc=l.pool(r.alloc,l.Array.prototype.subarray)),r.prototype._push=function(e,t,o){return this.tail=this.tail.next=new n(e,t,o),this.len+=t,this},a.prototype=Object.create(n.prototype),a.prototype.fn=function(e,t,n){for(;127<e;)t[n++]=128|127&e,e>>>=7;t[n]=e},r.prototype.uint32=function(e){return this.len+=(this.tail=this.tail.next=new a(128>(e>>>=0)?1:16384>e?2:2097152>e?3:268435456>e?4:5,e)).len,this},r.prototype.int32=function(e){return 0>e?this._push(d,10,u.fromNumber(e))// 10 bytes per spec
:this.uint32(e)},r.prototype.sint32=function(e){return this.uint32((e<<1^e>>31)>>>0)},r.prototype.uint64=function(e){var t=u.from(e);return this._push(d,t.length(),t)},r.prototype.int64=r.prototype.uint64,r.prototype.sint64=function(e){var t=u.from(e).zzEncode();return this._push(d,t.length(),t)},r.prototype.bool=function(e){return this._push(s,1,e?1:0)},r.prototype.fixed32=function(e){return this._push(p,4,e>>>0)},r.prototype.sfixed32=r.prototype.fixed32,r.prototype.fixed64=function(e){var t=u.from(e);return this._push(p,4,t.lo)._push(p,4,t.hi)},r.prototype.sfixed64=r.prototype.fixed64,r.prototype.float=function(e){return this._push(l.float.writeFloatLE,4,e)},r.prototype.double=function(e){return this._push(l.float.writeDoubleLE,8,e)};var m=l.Array.prototype.set?function(e,t,n){t.set(e,n)}/* istanbul ignore next */:function(e,t,n){for(var o=0;o<e.length;++o)t[n+o]=e[o]};/**
