...
declare module "natives" {
	...
	export function interruptConversation(p0: number, p1: number, p2: number): void;
	export function _0x8A694D7A68F8DC38(p0: number, p1: string, p2: string): void;
	export function _0xAA19F5572C38B564(p0: number): number;
	...
	export function setVariableOnSound(soundId: number, p1: number, p2: number): void;
	export function setVariableOnStream(p0: string, p1: number): void;
	export function overrideUnderwaterStream(p0: number, p1: boolean): void;
	...
	export function _0xEE066C7006C49C0A(p0: number, p1: number, p2: number): void;
	...
	export function setAmbientZoneListState(p0: number, p1: boolean, p2: boolean): void;
	export function clearAmbientZoneListState(p0: number, p1: boolean): void;
	...
	export function prepareSynchronizedAudioEventForScene(p0: number, p1: number): boolean;
	export function playSynchronizedAudioEvent(p0: number): boolean;
	export function stopSynchronizedAudioEvent(p0: number): boolean;
	export function _0xC8EDE9BDBCCBA6D4(p0: number, p1: number, p2: number, p3: number): void;
	...
	export function ugcCreateContent(data: number, dataCount: number, contentName: string, description: string, tagsCsv: string, contentTypeName: string, publish: boolean): boolean;
	...
	export function ugcUpdateContent(contentId: string, data: number, dataCount: number, contentName: string, description: string, tagsCsv: string, contentTypeName: string): boolean;
	...
	export function _0x4DFDD9EB705F8140(p0: boolean): boolean;
	export function datafileIsSavePending(): boolean;
	export function objectValueAddBoolean(objectData: number, key: string, value: boolean): void;
	export function objectValueAddInteger(objectData: number, key: string, value: number): void;
	export function objectValueAddFloat(objectData: number, key: string, value: number): void;
	export function objectValueAddString(objectData: number, key: string, value: string): void;
	export function objectValueAddVector3(objectData: number, key: string, valueX: number, valueY: number, valueZ: number): void;
	export function objectValueAddObject(objectData: number, key: string): number;
	export function objectValueAddArray(objectData: number, key: string): number;
	export function objectValueGetBoolean(objectData: number, key: string): boolean;
	export function objectValueGetInteger(objectData: number, key: string): number;
	export function objectValueGetFloat(objectData: number, key: string): number;
	export function objectValueGetString(objectData: number, key: string): string;
	export function objectValueGetVector3(objectData: number, key: string): Vector3;
	export function objectValueGetObject(objectData: number, key: string): number;
	export function objectValueGetArray(objectData: number, key: string): number;
	export function objectValueGetType(objectData: number, key: string): number;
	export function arrayValueAddBoolean(arrayData: number, value: boolean): void;
	export function arrayValueAddInteger(arrayData: number, value: number): void;
	export function arrayValueAddFloat(arrayData: number, value: number): void;
	export function arrayValueAddString(arrayData: number, value: string): void;
	export function arrayValueAddVector3(arrayData: number, valueX: number, valueY: number, valueZ: number): void;
	export function arrayValueAddObject(arrayData: number): number;
	export function arrayValueGetBoolean(arrayData: number, arrayIndex: number): boolean;
	export function arrayValueGetInteger(arrayData: number, arrayIndex: number): number;
	export function arrayValueGetFloat(arrayData: number, arrayIndex: number): number;
	export function arrayValueGetString(arrayData: number, arrayIndex: number): string;
	export function arrayValueGetVector3(arrayData: number, arrayIndex: number): Vector3;
	export function arrayValueGetObject(arrayData: number, arrayIndex: number): number;
	export function arrayValueGetSize(arrayData: number): number;
	export function arrayValueGetType(arrayData: number, arrayIndex: number): number;
	...
	export function hasCloudRequestsFinished(p0: boolean, unused: number): boolean;
	...
	export function getEntityMatrix(entity: number, rightVector: vectorPtr, forwardVector: vectorPtr, upVector: vectorPtr, position: vectorPtr): void;
	...
	export function playSynchronizedMapEntityAnim(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number, p8: number, p9: number, p10: number, p11: number): boolean;
	...
	export function findAnimEventPhase(animDictionary: string, animName: string, p2: string, p3: number, p4: number): boolean;
	...
	export function getEntityProofs(entity: number, bulletProof: boolean, fireProof: boolean, explosionProof: boolean, collisionProof: boolean, meleeProof: boolean, p6: boolean, p7: boolean, drownProof: boolean): boolean;
	...
	export function getTattooCollectionData(character: number, index: number, outComponent: number): boolean;
	...
	export function getShopPedComponent(componentHash: number, outComponent: number): void;
	export function getShopPedQueryProp(p0: number, p1: number): void;
	export function getShopPedProp(componentHash: number, outProp: number): void;
	...
	export function getVariantComponent(componentHash: number, componentId: number, p2: number, p3: number, p4: number): void;
	...
	export function getForcedComponent(componentHash: number, componentId: number, nameHash: number, enumValue: number, componentType: number): void;
	export function _0xE1CA84EBF72E691D(p0: number, p1: number, p2: number, p3: number, p4: number): void;
	...
	export function getShopPedQueryOutfit(p0: number, outfit: number): void;
	export function getShopPedOutfit(p0: number, p1: number): void;
	export function getShopPedOutfitLocate(p0: number): number;
	export function getShopPedOutfitPropVariant(outfit: number, slot: number, item: number): boolean;
	export function getShopPedOutfitComponentVariant(outfit: number, slot: number, item: number): boolean;
	...
	export function getClosestFirePos(outPosition: vectorPtr, x: number, y: number, z: number): boolean;
	...
	export function _0x4862437A486F91B0(p0: number, p1: number, p2: number, p3: number): boolean;
	...
	export function getScriptGfxPosition(p0: number, p1: number, p2: number, p3: number): void;
    ...
    export function getScreenCoordFromWorldCoord(worldX: number, worldY: number, worldZ: number, screenX: number, screenY: number): Array<any>;
	...
	export function _0x632B2940C67F4EA9(scaleformHandle: number, p1: number, p2: number, p3: number): boolean;
	...
	export function _0x317EBA71D7543F52(p0: number, p1: number, p2: number, p3: number): void;
	...
	export function drawNotificationApartmentInvite(p0: boolean, p1: boolean, p2: number, p3: number, isLeader: boolean, unk0: boolean, clanDesc: number, R: number, G: number, B: number): number;
	export function drawNotificationClanInvite(p0: boolean, p1: boolean, p2: number, p3: number, isLeader: boolean, unk0: boolean, clanDesc: number, playerName: string, R: number, G: number, B: number): number;
	...
	export function _0x8EFCCF6EC66D85E4(p0: number, p1: number, p2: number, p3: boolean, p4: boolean): number;
	export function _0xB6871B0555B02996(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number): number;
	...
	export function _0x817B86108EB94E51(p0: boolean, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number, p8: number): void;
	...
	export function setWarningMessageWithHeader(titleMsg: string, p1: string, flags: number, promptMsg: string, p4: boolean, p5: number, p6: number, p7: number, showBg: boolean, p9: number): void;
	export function setWarningMessage3(entryHeader: string, entryLine1: string, instructionalKey: number, entryLine2: string, p4: boolean, p5: number, p6: number, p7: number, p8: number, p9: boolean, p10: number): void;
	export function setWarningMessageWithHeaderUnk(entryHeader: string, entryLine1: string, flags: number, entryLine2: string, p4: boolean, p5: number, p6: number, p7: number, showBg: boolean, p9: number, p10: number): void;
	...
	export function _0xC8E1071177A23BE5(p0: number, p1: number, p2: number): boolean;
	...
	export function _0x36C1451A88A09630(p0: number, p1: number): void;
	...
	export function _0xEF4CED81CEBEDC6D(p0: number, p1: number): boolean;
	export function _0xCA6B2F7CE32AB653(p0: number, p1: number, p2: number): boolean;
	export function _0x90A6526CF0381030(p0: number, p1: number, p2: number, p3: number): boolean;
	export function _0x24A49BEAF468DC90(p0: number, p1: number, p2: number, p3: number, p4: number): boolean;
	export function _0x5FBD7095FE7AE57F(p0: number, p1: number): boolean;
	export function _0x8F08017F9D7C47BD(p0: number, p1: number, p2: number): boolean;
	export function _0x052991E59076E4E4(p0: number, p1: number): boolean;
	...
	export function getInteriorInfo(interior: number, position: vectorPtr, nameHash: number): void;
	...
	export function getBaseElementMetadata(p0: number, p1: number, p2: number, p3: boolean): boolean;
	...
	export function _0xF2F6A2FA49278625(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number, p8: number, p9: number, p10: number, p11: number, p12: number): void;
	...
	export function registerSaveHouse(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number): number;
	...
	export function _0xA4A0065E39C9F25C(p0: vectorPtr, p1: number, fadeInAfterLoad: boolean, p3: boolean): boolean;
	...
	export function getModelDimensions(modelHash: number, minimum: vectorPtr, maximum: vectorPtr): void;
	...
	export function getProjectileNearPedCoords(ped: number, weaponHash: number, radius: number, entity: number, p4: boolean): boolean;
	...
	export function setBitsInRange(unkVar: number, rangeStart: number, rangeEnd: number, p3: number): void;
	...
	export function startSaveData(p0: number, p1: number, p2: boolean): void;
	export function stopSaveData(): void;
	export function _0xA09F896CE912481F(p0: boolean): number;
	export function registerIntToSave(p0: number, name: string): void;
	export function registerInt64ToSave(p0: number, name: string): void;
	export function registerEnumToSave(p0: number, name: string): void;
	export function registerFloatToSave(p0: number, name: string): void;
	export function registerBoolToSave(p0: number, name: string): void;
	export function registerTextLabelToSave(p0: number, name: string): void;
	export function registerTextLabelToSave2(p0: number, name: string): void;
	export function _0x48F069265A0E4BEC(p0: number, name: string): void;
	export function _0x8269816F6CFD40F8(p0: number, name: string): void;
	export function _0xFAA457EF263E8763(p0: number, name: string): void;
	export function startSaveStructWithSize(p0: number, size: number, structName: string): void;
	export function stopSaveStruct(): void;
	export function startSaveArrayWithSize(p0: number, size: number, arrayName: string): void;
	export function stopSaveArray(): void;
	export function copyMemory(dst: number, src: number, size: number): void;
	...
	export function createIncident(dispatchService: number, x: number, y: number, z: number, numUnits: number, radius: number, outIncidentID: number, p7: number, p8: number): boolean;
	export function createIncidentWithEntity(dispatchService: number, ped: number, numUnits: number, radius: number, outIncidentID: number, p5: number, p6: number): boolean;
	...
	export function findSpawnPointInDirection(x1: number, y1: number, z1: number, x2: number, y2: number, z2: number, distance: number, spawnPoint: vectorPtr): boolean;
	...
	export function displayOnscreenKeyboard2(p0: number, windowTitle: string, p2: number, defaultText: string, defaultConcat1: string, defaultConcat2: string, defaultConcat3: string, defaultConcat4: string, defaultConcat5: string, defaultConcat6: string, defaultConcat7: string, maxInputLength: number): void;
	...
	export function _0x8EF5573A1F801A5C(p0: number, p1: number, p2: number): boolean;
	...
	export function getMobilePhoneRotation(rotation: vectorPtr, p1: number): void;
	export function setMobilePhonePosition(posX: number, posY: number, posZ: number): void;
	export function getMobilePhonePosition(position: vectorPtr): void;
	...
	export function networkEarnFromChallengeWin(p0: number, p1: number, p2: boolean): void;
	export function networkEarnFromBounty(amount: number, networkHandle: number, p2: number, p3: number): void;
	...
	export function networkEarnFromAmbientJob(p0: number, p1: string, p2: number): void;
	export function _0xD20D79671A598594(p0: number, p1: number, p2: number): void;
	export function networkEarnFromJobBonus(p0: number, p1: number, p2: number): void;
	...
	export function networkCanSpendMoney2(p0: number, p1: boolean, p2: boolean, p3: boolean, p4: number, p5: number, p6: number): boolean;
	...
	export function networkSpentBuyWantedlevel(p0: number, p1: number, p2: boolean, p3: boolean): void;
	...
	export function networkSpentPayVehicleInsurancePremium(amount: number, vehicleModel: number, networkHandle: number, notBankrupt: boolean, hasTheMoney: boolean): void;
	export function networkSpentCallPlayer(p0: number, p1: number, p2: boolean, p3: boolean): void;
	...
	export function networkSpentPurchaseWarehouse(amount: number, data: number, p2: boolean, p3: boolean): void;
	...
	export function netGameserverBasketStart(transactionId: number, categoryHash: number, actionHash: number, flags: number): boolean;
	export function netGameserverBasketDelete(): boolean;
	export function netGameserverBasketEnd(): boolean;
	export function netGameserverBasketAddItem(itemData: number, quantity: number): boolean;
	export function netGameserverBasketIsFull(): boolean;
	export function netGameserverBasketApplyServerData(p0: number, p1: number): boolean;
	...
	export function netGameserverBeginService(transactionId: number, categoryHash: number, itemHash: number, actionTypeHash: number, value: number, flags: number): boolean;
	...
	export function networkGetFoundGamer(p0: number, p1: number): boolean;
	export function networkClearFoundGamers(): void;
	export function networkGetGamerStatus(p0: number): boolean;
	...
	export function _0x02A8BEC6FD9AF660(p0: number, p1: number): boolean;
	...
	export function networkSessionVoiceConnectToPlayer(p0: number): void;
	...
	export function networkDoTransitionQuickmatchWithGroup(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number): boolean;
	...
	export function networkSetTransitionCreatorHandle(p0: number): void;
	export function networkClearTransitionCreatorHandle(): void;
	export function networkInviteGamersToTransition(p0: number, p1: number): boolean;
	...
	export function networkDoTransitionToFreemode(p0: number, p1: number, p2: boolean, players: number, p4: boolean): boolean;
	export function networkDoTransitionToNewFreemode(p0: number, p1: number, players: number, p3: boolean, p4: boolean, p5: boolean): boolean;
	export function networkIsTransitionToGame(): boolean;
	export function networkGetTransitionMembers(data: number, dataCount: number): number;
	...
	export function networkSendTransitionGamerInstruction(networkHandle: number, p1: string, p2: number, p3: number, p4: boolean): boolean;
	export function networkMarkTransitionGamerAsFullyJoined(p0: number): boolean;
	...
	export function networkHasInvitedGamerToTransition(p0: number): boolean;
	export function _0x3F9990BF5F22759C(p0: number): boolean;
	export function networkIsActivitySession(): boolean;
	export function _0x4A9FDE3A5A6D0437(toggle: boolean): void;
	export function networkSendPresenceInvite(networkHandle: number, p1: number, p2: number, p3: number): boolean;
	export function networkSendPresenceTransitionInvite(p0: number, p1: number, p2: number, p3: number): boolean;
	export function _0x1171A97A3D3981B6(p0: number, p1: number, p2: number, p3: number): boolean;
	...
	export function networkGetPresenceInviteHandle(p0: number, p1: number): boolean;
	...
	export function networkRemoveTransitionInvite(p0: number): void;
	export function networkRemoveAllTransitionInvite(): void;
	export function _0xF083835B70BA9BFE(): void;
	export function networkInviteGamers(p0: number, p1: number, p2: number, p3: number): boolean;
	export function networkHasInvitedGamer(p0: number): boolean;
	export function _0x71DC455F5CD1C2B1(networkHandle: number): boolean;
	export function _0x3855FB5EB2C5E8B2(p0: number): number;
	export function networkGetCurrentlySelectedGamerHandleFromInviteMenu(p0: number): boolean;
	export function networkSetCurrentlySelectedGamerHandleFromInviteMenu(p0: number): boolean;
	export function networkSetInviteOnCallForInviteMenu(p0: number): void;
	export function networkCheckDataManagerSucceededForHandle(p0: number, p1: number): boolean;
	export function _0x4AD490AE1536933B(p0: number, p1: number): number;
	export function _0x0D77A82DC2D0DA59(p0: number, p1: number): void;
	export function filloutPmPlayerList(networkHandle: number, p1: number, p2: number): boolean;
	export function filloutPmPlayerListWithNames(p0: number, p1: number, p2: number, p3: number): boolean;
	export function _0xE26CCFF8094D8C74(p0: number): boolean;
	export function networkSetCurrentDataManagerHandle(p0: number): boolean;
	export function networkIsInPlatformParty(): boolean;
	export function networkGetPlatformPartyUnk(): number;
	export function networkGetPlatformPartyMembers(data: number, dataSize: number): number;
	...
	export function badSportPlayerLeftDetected(networkHandle: number, event: number, amountReceived: number): boolean;
	...
	export function networkGetNumScriptParticipants(p0: number, p1: number, p2: number): number;
	export function _0x638A3A81733086DB(): number;
	export function _0x1AD5B71586B94820(p0: number, p1: number, p2: number): boolean;
	...
	export function networkGetDestroyerOfEntity(p0: number, p1: number, weaponHash: number): boolean;
	...
	export function _0xD66C9E72B3CC4982(p0: number, p1: number): number;
	...
	export function networkIsHandleValid(networkHandle: number, bufferSize: number): boolean;
	...
	export function networkIsInactiveProfile(p0: number): boolean;
	...
	export function networkAddFriend(networkHandle: number, message: string): boolean;
	...
	export function networkGamerHasHeadset(networkHandle: number): boolean;
	export function networkIsGamerTalking(networkHandle: number): boolean;
	export function networkCanCommunicateWithGamer2(networkHandle: number): boolean;
	export function networkCanCommunicateWithGamer(networkHandle: number): boolean;
	export function networkIsGamerMutedByMe(networkHandle: number): boolean;
	export function networkAmIMutedByGamer(networkHandle: number): boolean;
	export function networkIsGamerBlockedByMe(networkHandle: number): boolean;
	export function networkAmIBlockedByGamer(networkHandle: number): boolean;
	export function networkCanViewGamerUserContent(networkHandle: number): boolean;
	export function networkHasViewGamerUserContentResult(networkHandle: number): boolean;
	export function networkCanPlayMultiplayerWithGamer(networkHandle: number): boolean;
	export function networkCanGamerPlayMultiplayerWithMe(networkHandle: number): boolean;
	...
	export function networkClanPlayerGetDesc(clanDesc: number, bufferSize: number, networkHandle: number): boolean;
	export function networkClanIsRockstarClan(clanDesc: number, bufferSize: number): boolean;
	export function _0xF45352426FF3A4F0(clanDesc: number, bufferSize: number, p2: string): void;
	export function networkClanGetNumMembershipDesc(): number;
	export function networkClanGetMembershipDesc(memberDesc: number, p1: number): boolean;
	export function networkClanDownloadMembership(networkHandle: number): boolean;
	export function networkClanDownloadMembershipPending(p0: number): boolean;
	...
	export function networkClanGetMembershipValid(p0: number, p1: number): boolean;
	export function networkClanGetMembership(p0: number, clanMembership: number, p2: number): boolean;
	...
	export function networkClanGetEmblemTxdName(netHandle: number, txdName: string): boolean;
	export function _0x13518FF1C6B28938(p0: number): boolean;
	export function _0xA134777FF7F33331(p0: number, p1: number): boolean;
	...
	export function networkGetPrimaryClanDataStart(p0: number, p1: number): boolean;
	export function networkGetPrimaryClanDataPending(): number;
	export function networkGetPrimaryClanDataSuccess(): number;
	export function networkGetPrimaryClanDataNew(p0: number, p1: number): boolean;
	...
	export function getDateAndTimeFromUnixEpoch(unixEpoch: number, timeStructure: number): void;
	...
	export function _0x3C891A251567DFCE(p0: number): number;
	export function _0xFB8F2A6F3DF08CBE(): void;
	export function networkGetRespawnResult(randomInt: number, coordinates: vectorPtr, heading: number): void;
	...
	export function _0x152D90E4C1B4738A(p0: number, p1: number): boolean;
	...
	export function _0x9BF438815F5D96EA(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number): boolean;
	export function _0x692D58DF40657E8C(p0: number, p1: number, p2: number, p3: number, p4: number, p5: boolean): boolean;
	export function ugcQueryByContentId(contentId: string, latestVersion: boolean, contentTypeName: string): boolean;
	export function ugcQueryByContentIds(data: number, count: number, latestVersion: boolean, contentTypeName: string): boolean;
	export function ugcQueryRecentlyCreatedContent(offset: number, count: number, contentTypeName: string, p3: number): boolean;
	export function _0xD5A4B59980401588(p0: number, p1: number, p2: number, p3: number): boolean;
	export function _0x3195F8DD0D531052(p0: number, p1: number, p2: number, p3: number): boolean;
	export function _0xF9E1CCAE8BA4C281(p0: number, p1: number, p2: number, p3: number): boolean;
	export function _0x9F6E2821885CAEE2(p0: number, p1: number, p2: number, p3: number, p4: number): boolean;
	export function _0x678BB03C1A3BD51E(p0: number, p1: number, p2: number, p3: number, p4: number): boolean;
	export function setBalanceAddMachine(contentId: string, contentTypeName: string): boolean;
	export function setBalanceAddMachines(data: number, dataCount: number, contentTypeName: string): boolean;
	export function _0xA7862BC5ED1DFD7E(p0: number, p1: number, p2: number, p3: number): boolean;
	export function _0x97A770BEEF227E2B(p0: number, p1: number, p2: number, p3: number): boolean;
	export function _0x5324A0E3E4CE3570(p0: number, p1: number, p2: number, p3: number): boolean;
	...
	export function _0x584770794D758C18(p0: number, p1: number): boolean;
	...
	export function _0xCFD115B373C0DF63(p0: number, p1: number): void;
	...
	export function _0x274A1519DFC1094F(p0: number, p1: boolean, p2: number): boolean;
	export function _0xD05D1A6C74DA3498(p0: number, p1: boolean, p2: number): boolean;
	...
	export function _0xB746D20B17F2A229(p0: number, p1: number): boolean;
	...
	export function textureDownloadRequest(PlayerHandle: number, FilePath: string, Name: string, p3: boolean): number;
	export function _0x0B203B4AFDE53A4F(p0: number, p1: number, p2: boolean): number;
	export function _0x308F96458B7087CC(p0: number, p1: number, p2: number, p3: number, p4: number, p5: boolean): number;
	...
	export function networkGetBanData(p0: number, banType: number, timeData: number): boolean;
	...
	export function _0x163F8B586BC95F2A(object: number, radius: number, modelHash: number, x: number, y: number, z: number, p6: vectorPtr, p7: number): number;
	...
	export function _0x589F80B325CC82C5(p0: number, p1: number, p2: number, p3: number, p4: number): boolean;
	...
	export function _0xADF084FB8F075D06(p0: number): number;
	export function setObjectColour(object: number, toggle: boolean): void;
	...
	export function getSafeCoordForPed(x: number, y: number, z: number, onGround: boolean, outPosition: vectorPtr, flags: number): boolean;
	export function getClosestVehicleNode(x: number, y: number, z: number, outPosition: vectorPtr, nodeType: number, p5: number, p6: number): boolean;
	export function getClosestMajorVehicleNode(x: number, y: number, z: number, outPosition: vectorPtr, unknown1: number, unknown2: number): boolean;
	export function getClosestVehicleNodeWithHeading(x: number, y: number, z: number, outPosition: vectorPtr, outHeading: number, nodeType: number, p6: number, p7: number): boolean;
	export function getNthClosestVehicleNode(x: number, y: number, z: number, nthClosest: number, outPosition: vectorPtr, unknown1: number, unknown2: number, unknown3: number): boolean;
	...
	export function getNthClosestVehicleNodeWithHeading(x: number, y: number, z: number, nthClosest: number, outPosition: vectorPtr, heading: number, unknown1: number, unknown2: number, unknown3: number, unknown4: number): boolean;
	export function getNthClosestVehicleNodeIdWithHeading(x: number, y: number, z: number, nthClosest: number, outPosition: vectorPtr, outHeading: number, p6: number, p7: number, p8: number): boolean;
	export function getNthClosestVehicleNodeFavourDirection(x: number, y: number, z: number, desiredX: number, desiredY: number, desiredZ: number, nthClosest: number, outPosition: vectorPtr, outHeading: number, nodetype: number, p10: number, p11: number): boolean;
	...
	export function getVehicleNodePosition(nodeId: number, outPosition: vectorPtr): void;
	...
	export function getClosestRoad(x: number, y: number, z: number, p3: number, p4: number, p5: vectorPtr, p6: vectorPtr, p7: number, p8: number, p9: number, p10: boolean): number;
	...
	export function getRandomVehicleNode(x: number, y: number, z: number, radius: number, p4: boolean, p5: boolean, p6: boolean, outPosition: vectorPtr, nodeId: number): boolean;
	...
	export function addRelationshipGroup(name: string, groupHash: number): number;
	...
	export function getGroupSize(groupID: number, unknown: number, sizeInMembers: number): void;
	...
	export function _0x9E30E91FB03A2CAF(p0: number, p1: number): boolean;
	...
	export function getPedHeadBlendData(ped: number, headBlendData: number): boolean;
	...
	export function getPedHairRgbColor(p0: number, r: number, g: number, b: number): void;
	export function getPedMakeupRgbColor(p0: number, r: number, g: number, b: number): void;
	...
	export function getClosestPed(x: number, y: number, z: number, radius: number, p4: boolean, p5: boolean, outPed: number, p7: boolean, p8: boolean, pedType: number): boolean;
	...
	export function applyPedBloodByZone(ped: number, p1: number, p2: number, p3: number, p4: number): void;
	export function applyPedBloodSpecific(ped: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number, p8: number): void;
	...
	export function _0xF60165E1D2C5370B(ped: number, p1: number, p2: number): boolean;
	...
	export function _0x280C7E3AC7F56E90(p0: number, p1: number, p2: number, p3: number): void;
	export function _0xB782F8238512BAD5(p0: number, p1: number): void;
	...
	export function _0xE861D0B05C7662B8(p0: number, p1: number, p2: number): void;
	...
	export function addRope(x: number, y: number, z: number, rotX: number, rotY: number, rotZ: number, length: number, ropeType: number, maxLength: number, minLength: number, p10: number, p11: boolean, p12: boolean, rigid: boolean, p14: number, breakWhenShot: boolean, unkPtr: number): number;
	...
	export function attachEntitiesToRope(ropeId: number, ent1: number, ent2: number, ent1_x: number, ent1_y: number, ent1_z: number, ent2_x: number, ent2_y: number, ent2_z: number, length: number, p10: boolean, p11: boolean, p12: number, p13: number): void;
	...
	export function setPlayerWantedCentrePosition(player: number, position: vectorPtr, p2: boolean, p3: boolean): void;
	...
	export function getEventData(eventGroup: number, eventIndex: number, argStruct: number, argStructSize: number): boolean;
	export function triggerScriptEvent(eventGroup: number, args: number, argCount: number, bit: number): void;
	...
	export function startShapeTestSurroundingCoords(pVec1: vectorPtr, pVec2: vectorPtr, flag: number, entity: number, flag2: number): number;
	export function getShapeTestResult(rayHandle: number, hit: boolean, endCoords: vectorPtr, surfaceNormal: vectorPtr, entityHit: number): number;
	export function getShapeTestResultIncludingMaterial(rayHandle: number, hit: boolean, endCoords: vectorPtr, surfaceNormal: vectorPtr, materialHash: number, entityHit: number): number;
	...
	export function scInboxMessageSendUgcStatUpdateEvent(data: number): void;
	export function scInboxMessageGetUgcdata(p0: number, p1: number): boolean;
	export function scInboxMessageSendBountyPresenceEvent(data: number): boolean;
	export function scInboxMessageGetBountyData(index: number, outData: number): boolean;
	...
	export function _0x4737980E8A283806(p0: number, p1: number): boolean;
	export function _0x44ACA259D67651DB(p0: number, p1: number): void;
	...
	export function _0x287F1F75D2803595(p0: number, p1: number): boolean;
	...
	export function _0xD0EE05FE193646EA(p0: number, p1: number, p2: number): boolean;
	export function _0x1989C6E6F67E76A8(p0: number, p1: number, p2: number): boolean;
	export function _0x07C61676E5BB52CD(p0: number): number;
	export function _0x8147FFF6A718E1AD(p0: number): number;
	export function _0x0F73393BAC7E6730(p0: number, p1: number): boolean;
	...
	export function _0x4A7D6E727F941747(p0: number): number;
	...
	export function _0x8CC469AB4D349B7C(p0: number, p1: string, p2: number): boolean;
	export function _0xC5A35C73B68F3C49(): number;
	export function _0x699E4A5C8C893A18(p0: number, p1: string, p2: number): boolean;
	export function _0x19853B5B17D77BCA(p0: number, p1: number): boolean;
	...
	export function statSetDate(statName: number, value: number, numFields: number, save: boolean): boolean;
	...
	export function statGetInt(statHash: number, outValue: number, p2: number): boolean;
	export function statGetFloat(statHash: number, outValue: number, p2: number): boolean;
	export function statGetBool(statHash: number, outValue: boolean, p2: number): boolean;
	export function statGetDate(statHash: number, p1: number, p2: number, p3: number): boolean;
	export function statGetString(statHash: number, p1: number): string;
	export function statGetPos(p0: number, p1: number, p2: number, p3: number, p4: number): boolean;
	export function statGetMaskedInt(p0: number, p1: number, p2: number, p3: number, p4: number): boolean;
	...
	export function playstatsNpcInvite(p0: number): void;
	...
	export function playstatsMissionStarted(p0: number, p1: number, p2: number, p3: boolean): void;
	export function playstatsMissionOver(p0: number, p1: number, p2: number, p3: boolean, p4: boolean, p5: boolean): void;
	export function playstatsMissionCheckpoint(p0: number, p1: number, p2: number, p3: number): void;
	...
	export function _0xF8C54A461C3E11DC(p0: number, p1: number, p2: number, p3: number): void;
	export function _0xF5BB8DAC426A52C0(p0: number, p1: number, p2: number, p3: number): void;
	export function _0xA736CF7FB7C5BFF4(p0: number, p1: number, p2: number, p3: number): void;
	export function _0x14E0B2D1AD1044E0(p0: number, p1: number, p2: number, p3: number): void;
	...
	export function playstatsDirectorMode(p0: number): void;
	...
	export function playstatsPiMenuHideSettings(data: number): void;
	...
	export function leaderboards2ReadFriendsByRow(p0: number, p1: number, p2: number, p3: boolean, p4: number, p5: number): boolean;
	export function leaderboards2ReadByHandle(p0: number, p1: number): boolean;
	export function leaderboards2ReadByRow(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number): boolean;
	export function leaderboards2ReadByRank(p0: number, p1: number, p2: number): boolean;
	export function leaderboards2ReadByRadius(p0: number, p1: number, p2: number): boolean;
	export function leaderboards2ReadByScoreInt(p0: number, p1: number, p2: number): boolean;
	export function leaderboards2ReadByScoreFloat(p0: number, p1: number, p2: number): boolean;
	export function _0xC38DC1E90D22547C(p0: number, p1: number, p2: number): boolean;
	export function leaderboards2ReadByPlatform(p0: number, gamerHandleCsv: string, platformName: string): boolean;
	export function _0xA0F93D5465B3094D(p0: number): boolean;
	export function _0x71B008056E5692D6(): void;
	export function _0x34770B9CE0E03B91(p0: number, p1: number): boolean;
	...
	export function leaderboards2WriteData(p0: number): boolean;
	...
	export function leaderboardsCacheDataRow(p0: number): boolean;
	...
	export function leaderboardsGetCacheDataRow(p0: number, p1: number, p2: number): boolean;
	...
	export function _0x6483C25849031C4F(p0: number, p1: number, p2: number, p3: number): void;
	...
	export function leaderboards2WriteDataForEventType(p0: number, p1: number): boolean;
	...
	export function _0xDEAAF77EB3687E97(p0: number, p1: number): number;
	export function statSaveMigrationStatusStart(): boolean;
	export function statGetSaveMigrationStatus(data: number): number;
	...
	export function playstatsDupeDetection(data: number): void;
	export function playstatsBanAlert(p0: number): void;
	export function playstatsGunrunMissionEnded(data: number): void;
	...
	export function playstatsStoneHatchetEnd(data: number): void;
	export function playstatsSmugMissionEnded(data: number): void;
	export function playstatsH2FmprepEnd(data: number): void;
	export function playstatsH2InstanceEnd(data: number, p1: number, p2: number, p3: number): void;
	export function playstatsDarMissionEnd(data: number): void;
	export function playstatsEnterSessionPack(data: number): void;
	...
	export function playstatsArenaWarsEnded(data: number): void;
	...
	export function getNavmeshRouteDistanceRemaining(ped: number, p1: number, p2: number): number;
	...
	export function taskScriptedAnimation(ped: number, p1: number, p2: number, p3: number, p4: number, p5: number): void;
	export function playEntityScriptedAnim(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number): void;
	...
	export function doesScenarioOfTypeExistInArea(p0: number, p1: number, p2: number, p3: number, p4: number, p5: boolean): boolean;
	...
	export function waypointRecordingGetCoord(name: string, point: number, coord: vectorPtr): boolean;
	...
	export function useWaypointRecordingAsAssistedMovementRoute(p0: number, p1: boolean, p2: number, p3: number): void;
	...
	export function taskMoveNetworkScripted(ped: number, p1: string, data: number, p3: number, p4: boolean, animDict: string, flags: number): void;
	...
	export function taskSweepAimPosition(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number, p8: number, p9: number, p10: number): void;
	...
	export function hasVehicleRecordingBeenLoaded(p0: number, p1: number): boolean;
	export function removeVehicleRecording(p0: number, p1: number): void;
	...
	export function getRotationOfVehicleRecordingAtTime(p0: number, p1: number, p2: number): Vector3;
	...
	export function startPlaybackRecordedVehicleUsingAi(p0: number, p1: number, p2: number, p3: number, p4: number): void;
	...
	export function setMissionTrainAsNoLongerNeeded(train: number, p1: boolean): void;
	...
	export function _0xA4822F1CF23F4810(outVec: vectorPtr, p1: number, outVec1: vectorPtr, p3: number, p4: number, p5: number, p6: number, p7: number, p8: number): boolean;
	...
	export function getVehicleModColor1(vehicle: number, paintType: number, color: number, p3: number): void;
	...
	export function _0xDF7E3EEB29642C38(vehicle: number, out1: vectorPtr, out2: vectorPtr): void;
	...
	export function testProbeAgainstWater(x1: number, y1: number, z1: number, x2: number, y2: number, z2: number, result: vectorPtr): boolean;
	...
	export function testVerticalProbeAgainstAllWater(x: number, y: number, z: number, p3: number, height: number): boolean;
	...
	export function getCurrentPedWeapon(ped: number, weaponHash: number, p2: boolean): boolean;
	...
	export function getMaxAmmo2(ped: number, weaponHash: number, ammo: number): boolean;
	...
	export function getPedLastWeaponImpactCoord(ped: number, coords: vectorPtr): boolean;
	...
	export function getWeaponHudStats(weaponHash: number, outData: number): boolean;
