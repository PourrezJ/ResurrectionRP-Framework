...
namespace ResurrectionRP_Server.Bank
{
    ...
    public class BankMenu
    {
        ...
        #region Menu
        public static async Task<Menu> OpenBankMenu(IPlayer client, BankAccount bankAccount, AtmType atmType = AtmType.ATM)
        {
            #region Vérification
        ...
        private async Task<Menu> OpenBankMenu(IPlayer client)
        {
            ...
            #region Withdraw
            var withdrawItem = new MenuItem("Retirer", executeCallback: true);
            ...
            #region Deposit
            var depositItem = new MenuItem("Déposer", executeCallback: true);
