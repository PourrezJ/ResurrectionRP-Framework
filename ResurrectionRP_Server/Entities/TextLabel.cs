...
namespace ResurrectionRP_Server.Entities
{
    public class TextLabel : Entity
    {
        ...
        public static TextLabel CreateTextLabel(string label, Vector3 pos, Color? color = null, int font = 2, int drawDistance = 5, int dimension = GameMode.GlobalDimension)
        {
