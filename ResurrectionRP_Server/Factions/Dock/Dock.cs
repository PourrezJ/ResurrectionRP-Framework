...
namespace ResurrectionRP_Server.Factions
{
    ...
    public partial class Dock : Faction
    {
        ...
        public override Faction Init()
        {
            ...
            {
                new FactionVehicle(0, VehicleModel.Forklift, 15000, 5),
                new FactionVehicle(1, VehicleModel.Benson, 400000, 200),

                // Pawn car
                new FactionVehicle(1, VehicleModel.Reaper, 507500, 15),
                new FactionVehicle(1, VehicleModel.Vacca, 343000, 15),
                new FactionVehicle(1, VehicleModel.Turismor, 472500, 15),
                new FactionVehicle(1, VehicleModel.Infernus, 339500, 15),
                new FactionVehicle(1, VehicleModel.Banshee, 385000, 15),
                new FactionVehicle(1, VehicleModel.Fmj, 630000, 15),
                new FactionVehicle(1, VehicleModel.T20, 525000, 15),
                new FactionVehicle(1, VehicleModel.Osiris, 560000, 15),
                new FactionVehicle(1, VehicleModel.Tyrus, 927500, 15),
                new FactionVehicle(1, VehicleModel.Prototipo, 1120000, 15),
                new FactionVehicle(1, VehicleModel.Pfister811, 577500, 15),
                new FactionVehicle(1, VehicleModel.Bullet, 332500, 15),
                new FactionVehicle(1, VehicleModel.Voltic, 350000, 15),
                new FactionVehicle(1, VehicleModel.Zentorno, 770000, 15),
                new FactionVehicle(1, VehicleModel.Cheetah, 612500, 15),
                new FactionVehicle(1, VehicleModel.EntityXf, 402500, 15),
                new FactionVehicle(1, VehicleModel.Le7B, 980000, 15),
                new FactionVehicle(1, VehicleModel.Adder, 700000, 15),
                new FactionVehicle(1, VehicleModel.Autarch, 805000, 15),
                new FactionVehicle(1, VehicleModel.Cyclone, 525000, 15),
                new FactionVehicle(1, VehicleModel.Emerus, 665000, 15),
                new FactionVehicle(1, VehicleModel.Gp1, 455000, 15),
                new FactionVehicle(1, VehicleModel.Italigtb, 525000, 15),
                new FactionVehicle(1, VehicleModel.Krieger, 735000, 15),
                new FactionVehicle(1, VehicleModel.Nero, 875000, 15),
                new FactionVehicle(1, VehicleModel.Penetrator, 378000, 15),
                new FactionVehicle(1, VehicleModel.Sc1, 325500, 15),
                new FactionVehicle(1, VehicleModel.SultanRs, 133000, 15),
                new FactionVehicle(1, VehicleModel.Tezeract, 1330000, 15),
                new FactionVehicle(1, VehicleModel.Thrax, 1400000, 15),
                ...
                new FactionVehicle(1, (VehicleModel) VehicleModel2.rs72013, 119000, 25),
                new FactionVehicle(1, (VehicleModel) VehicleModel2.ben17, 157500, 30),
                new FactionVehicle(1, VehicleModel.Ztype, 325500, 15),
                new FactionVehicle(1, VehicleModel.BType, 294000, 15),
                new FactionVehicle(1, VehicleModel.Nebula, 14000, 15),
                new FactionVehicle(1, VehicleModel.Zion3, 21000, 15),
                new FactionVehicle(1, (VehicleModel) VehicleModel2.zl12017, 66500, 30),
                new FactionVehicle(1, (VehicleModel) VehicleModel2.rmodmustang, 112000, 30),
                new FactionVehicle(1, (VehicleModel) VehicleModel2.rt440, 52500, 30),
                new FactionVehicle(1, (VehicleModel) VehicleModel2.chevelle1970, 98000, 30),
                new FactionVehicle(1, (VehicleModel) VehicleModel2.stingray66, 108500, 30),
                new FactionVehicle(1, VehicleModel.Hotknife, 49000, 30),
                new FactionVehicle(1, VehicleModel.Hermes, 59500, 30),
                new FactionVehicle(1, VehicleModel.Hustler, 47950, 10),
                new FactionVehicle(1, VehicleModel.Dominator3, 66500, 30),
                new FactionVehicle(1, VehicleModel.Gauntlet4, 108500, 30),
                new FactionVehicle(1, VehicleModel.SabreGt2, 49000, 30),
                new FactionVehicle(1, (VehicleModel) VehicleModel2.v242, 24500, 25),
                new FactionVehicle(1, (VehicleModel) VehicleModel2.bmci, 94500, 25),
                new FactionVehicle(1, (VehicleModel) VehicleModel2.mers63c, 87500, 15),
                new FactionVehicle(1, VehicleModel.Dubsta3, 70000, 50),
                new FactionVehicle(1, (VehicleModel) VehicleModel2.nisaltima, 14000, 25),
                ...
                // Wolf Motor Shop
                new FactionVehicle(1, VehicleModel.Avarus, 46550, 5),
                new FactionVehicle(1, VehicleModel.Chimera, 122500, 5),
                new FactionVehicle(1, VehicleModel.Daemon, 29400, 5),
                new FactionVehicle(1, VehicleModel.Daemon2, 34300, 5),
                new FactionVehicle(1, VehicleModel.Hexer, 39200, 5),
                new FactionVehicle(1, VehicleModel.Innovation, 88200, 5),
                new FactionVehicle(1, VehicleModel.Wolfsbane, 36750, 5),
                new FactionVehicle(1, VehicleModel.Sovereign, 73500, 7),
                new FactionVehicle(1, VehicleModel.Zombieb, 29400, 5),
                new FactionVehicle(1, VehicleModel.Sanctus, 100000, 5),
                new FactionVehicle(1, VehicleModel.Faggio2, 1470, 5),
                new FactionVehicle(1, VehicleModel.Diablous2, 73500, 5),
                new FactionVehicle(1, VehicleModel.Nightblade, 122500, 5),

                // Tankers
                new FactionVehicle(1, VehicleModel.Tanker, 140000, 500),
                new FactionVehicle(1, VehicleModel.Tanker2, 140000, 500),
                new FactionVehicle(1, VehicleModel.ArmyTanker, 140000, 500),

                // Trailers
                new FactionVehicle(1, VehicleModel.TrFlat, 126000, 0),
                new FactionVehicle(1, VehicleModel.Trailers, 133000, 500),
                new FactionVehicle(1, VehicleModel.Trailers2, 154000, 500),
                new FactionVehicle(1, VehicleModel.Trailers3, 154000, 500),
                new FactionVehicle(1, VehicleModel.TrailerLogs, 140000, 500),
                new FactionVehicle(1, VehicleModel.DockTrailer, 140000, 500),

                new FactionVehicle(1, VehicleModel.Microlight, 150000, 15)
            };
            ...
            ItemShop.Add(new FactionShopItem(LoadItem.GetItemWithID(ItemID.Coffee), 0, 0));
        ...
        private bool Dock_CommandeValidate(IPlayer player, Menu menu, Dictionary<DockItemData, int> importItems)
        {
            ...
            foreach (KeyValuePair<DockItemData, int> item in importItems)
            {
                if (item.Value > 0)
                {
                    var itemData = LoadItem.GetItemWithName(item.Key.Name);
