            ...
            get => new List<Item>()
                {
                    ...
                    new Weapons(ItemID.Weapon, "Katana", "", 3, hash: WeaponHash.Bottle, isDockable: false, itemPrice: 3100),
                    ...
                    new SeedItem(ItemID.GOrange, "Graine d'Orange Bud", "", SeedType.Orange, 0.1, true, false, true, true, isDockable: false, itemPrice: 50,icon:"graine"),
                    new SeedItem(ItemID.GPurple, "Graine de Purple", "", SeedType.Purple, 0.1, true, false, true, true, isDockable: false, itemPrice: 50,icon:"graine"),
                    new SeedItem(ItemID.GSkunk, "Graine de Skunk", "", SeedType.Skunk, 0.1, true, false, true, true, isDockable: false, itemPrice: 50,icon:"graine"),
                    new SeedItem(ItemID.GWhite, "Graine de WhiteWidow", "", SeedType.WhiteWidow, 0.1, true, false, true, true, isDockable: false, itemPrice: 50,icon:"graine"),
                    new Unusable(ItemID.Secateur, "Sécateur", "Permet de se couper les ongles de pieds ou la beuh", 1, icon:"secateur", isDockable: false, itemPrice: 90),
                    new Unusable(ItemID.Hydro, "Système Hydroponique", "Ne permet pas de prendre sa douche", 1, icon:"hydroponics", isDockable: false, itemPrice: 350),
