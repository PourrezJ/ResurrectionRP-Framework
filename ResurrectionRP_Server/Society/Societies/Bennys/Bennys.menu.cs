...
namespace ResurrectionRP_Server.Society.Societies.Bennys
{
    public partial class Bennys
    {
        ...
        private async Task OpenMainMenu(IPlayer client, IVehicle vehicle)
        {
            ...
            Menu mainMenu = new Menu("ID_Main", "", SocietyName, backCloseMenu: true, banner: Banner.SuperMod);
        ...
        private async Task OpenPerformanceMenu(IPlayer client)
        {
            ...
            Menu menu = new Menu("ID_Perf", "", "Choisissez l'élément à installer :", banner: Banner.SuperMod);
        ...
        private async Task OpenPerformanceChoiseMenu(IPlayer client)
        {
            ...
            Menu menu = new Menu("ID_Perfs", "", _subtitle, banner: Banner.SuperMod);
        ...
        private async Task PerformanceChoiseMenuCallback(IPlayer client, Menu menu, IMenuItem menuItem, int itemIndex)
        {
            ...
            if (menuItem == null)
            {
                if (vh.Mods.ContainsKey(_modType))
                    await _vehicleBench.SetModAsync((byte)_modType, (byte)vh.Mods[_modType]);
                else
                    await _vehicleBench.SetModAsync((byte)_modType, 0);
        ...
        private async Task OpenDesignMenu(IPlayer client)
        {
            ...
            Menu menu = new Menu("ID_Design", "", "Choisissez l'élément à installer :", banner: Banner.SuperMod);
        ...
        private async Task OpenDesignChoiseMenu(IPlayer client)
        {
            ...
            Menu menu = new Menu("ID_DesignChoise", "", _subtitle, banner: Banner.SuperMod);
            menu.IndexChangeCallback = ModPreview;
        ...
        private async Task OpenHistoricMenu(IPlayer client)
        {
            ...
            else if (vh.Mods.Count >= 1)
            {
                ...
                Menu menu = new Menu("ID_Histo", "", "Historique :", Globals.MENU_POSX, Globals.MENU_POSY, Globals.MENU_ANCHOR, false, true, false, banner: Banner.SuperMod);
