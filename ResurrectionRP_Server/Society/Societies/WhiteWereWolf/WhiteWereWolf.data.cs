...
{
    public class WhiteWereWolfData
    {
        ...
        {
            new EsthetiqueData(0, "Scelle", 2000),
            new EsthetiqueData(1, "Guidon", 2000),
            ...
            new EsthetiqueData(23, "Roues AV", 2000),
            new EsthetiqueData(24, "Roues ARR", 2000),
