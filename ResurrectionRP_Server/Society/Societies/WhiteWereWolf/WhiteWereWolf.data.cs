namespace ResurrectionRP_Server.Society.Societies.WhiteWereWolf
{
    public partial class WhiteWereWolf : Garage
    {
        ...
        {
            new GarageData.EsthetiqueData(0, "Scelle", 2000),
            new GarageData.EsthetiqueData(1, "Guidon", 2000),
            ...
            new GarageData.EsthetiqueData(23, "Roues AV", 2000),
            new GarageData.EsthetiqueData(24, "Roues ARR", 2000),
